...
/*
     FILE ARCHIVED ON 7:44:13 Mar 25, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 20:56:23 Mar 8, 2015.
...
function(){a.lastIERng=a.selection.getRng()})})),b.editorContainer=u.editorContainer);e.content_css&&d(m(e.content_css),function(a){b.contentCSS.push(b.documentBaseURI.toAbsolute(a))});if(e.content_editable)return r=u=null,b.initContentBody();document.domain&&location.hostname!=document.domain&&(f.relaxedDomain=document.domain);b.iframeHTML=e.doctype+'<html><head xmlns="/web/20130325074413/http://www.w3.org/1999/xhtml">';e.document_base_url!=f.documentBaseURL&&(b.iframeHTML+='<base href="'+b.documentBaseURI.getURI()+
...
b){return g(b)}));a.onInit.add(function(){a.controlManager.setActive("pastetext",a.pasteAsPlainText);f(a,"paste_block_drop")&&a.dom.bind(a.getBody(),"dragend,dragover,draggesture,dragdrop,drop,drag".split(","),function(a){a.preventDefault();a.stopPropagation();return false})});h._legacySupport()},getInfo:function(){return{longname:"Paste text/word",author:"Moxiecode Systems AB",authorurl:"/web/20130325074413/http://tinymce.moxiecode.com",infourl:"/web/20130325074413/http://wiki.moxiecode.com/index.php/TinyMCE:Plugins/paste",version:tinymce.majorVersion+
...
"class":"btn",onclick:function(){ws.common.track("Editor","Stop","Cancel");d.timeTracker._recordEndTime();try{_gaq.push(function(){d.timeTracker._track(_gat._getTrackerByName(),void 0,"Editor")})}catch(a){}d.isContentDirty()&&d.editor.plugins.wsautosave.autosave(!1);d.noDirtyCheck=!0;document.location=d.editor.getParam("wssave_cancel_url")}}));return e},getInfo:function(){return{longname:"Wikispaces save",author:"Tangient LLC",authorurl:"/web/20130325074413/http://wikispaces.com",infourl:"/web/20130325074413/http://wikispaces.com",version:"0.1"}},
...
(a.prepend(a.prev().html()),a.prev().remove())},getInfo:function(){return{longname:"Wikispaces list",author:"Tangient LLC",authorurl:"/web/20130325074413/http://wikispaces.com",infourl:"/web/20130325074413/http://wikispaces.com",version:"0.1"}}});f.PluginManager.add("wslist",wikispaces.plugins.ListPlugin)})(tinymce,jQuery);
...
getInfo:function(){return{longname:"Wikispaces toolbar scroll",author:"Tangient LLC",authorurl:"/web/20130325074413/http://wikispaces.com",infourl:"/web/20130325074413/http://wikispaces.com",version:"0.1"}}});f.PluginManager.add("wstoolbarscroll",wikispaces.plugins.ToolbarScrollPlugin)})(tinymce,jQuery);
...
k.initial||("A"==c.nodeName&&!c.name&&-1==c.href.indexOf("#mce_temp_url#")&&"visual"==a.plugins.wscommon.getOption("mode")?f.mainEditor.plugins.wslinkoverlay.show(c):f.mainEditor.plugins.wslinkoverlay.hide())});a.onDblClick.add(function(a,b){"A"==b.target.nodeName&&("A"==b.target.nodeName&&a.selection.select(b.target),a.execCommand("wslink"))});a.plugins.wscommon.disableUntilLibsLoad(a,"wslink")},getInfo:function(){return{longname:"Wikispaces link",author:"Tangient LLC",authorurl:"/web/20130325074413/http://wikispaces.com",
...
height:340,uiSetup:function(a){c("#closePreviewButton").click(function(){a.close()})}});this.registerPlugin({options:{id:"glogster",name:"Glogster",type:"media",category:"poster",logo:"/i/glogster_widget_160x70.jpg",url:"/web/20130325074413/http://edu.glogster.com/?page=wiki_spaces&wikiaction=login",homepage_url:"/web/20130325074413/http://edu.glogster.com",terms_url:"/web/20130325074413/http://edu.glogster.com/terms-of-use"}})},setPlugin:function(a){this.plugin=a},onShow:function(a){this.setPlugin(a.plugin);this.resetMediaForms();a.plugin&&(a.plugin.editor.plugins.wsreference?
...
"digg"==a||"reddit"==a||"anchor"==a||"include"==a.substring(0,7)||c("#"+a+"MediaMenu").is(".hideTextMediaInstructions")?c(document.otherMediaForm).hide():c(document.otherMediaForm).show();"spinner"!=a&&(document.otherMediaForm.mediaType.value=a);c("#"+a+"MediaMenu").find('input[type="text"],textarea').eq(0).focus();this.editor.plugins.wspopup.resize("mediaTool")},submitYackpack:function(){var a="/web/20130325074413/http://www.yackpack.com/walkietalkie/?"+encodeURIComponent(document.yackpackMediaForm.channel.value);document.otherMediaForm.embedText.value=
a;document.otherMediaForm.save.click()},submitBittyBrowser:function(){document.otherMediaForm.embedText.value='bitty browser\nwebsite: "'+document.bittybrowserMediaForm.url.value+'"';document.otherMediaForm.save.click()},embedGabbly:function(){document.otherMediaForm.embedText.value="<iframe src='/web/20130325074413/http://cw.gabbly.com/gabbly/cw.jsp?e=1&t="+encodeURIComponent(location.protocol+"//"+location.host+"/"+wikispaces_page)+"' scrolling='no' style='width:300px; height:250px;' frameborder='0'></iframe>";document.otherMediaForm.save.click()},
...
author:"Tangient LLC",authorurl:"/web/20130325074413/http://wikispaces.com",infourl:"/web/20130325074413/http://wikispaces.com",version:"0.1"}},getNextRefId:function(){return++this.nextRefId},elementIdToRefId:function(a){return a.match(/-(\d+)$/)[1]},pullOutReferences:function(a){var b=!1,c=this;a.content=a.content.replace(/(&lt;ref(?:&gt;|>)((?:.|\n)*?)&lt;\/ref(?:&gt;|>))|(<pre\s+.*?>)|(<\/pre>)/gmi,function(a,f,h,k,l){if(f&&!b)return a=c.getNextRefId(),f=c.makeReferenceHtml(a),c.addReferenceEditor(a,h),f;k?b=!0:l&&(b=!1);return a})},
...
a.onNodeChange.add(function(a,b,f){ws.editor.content.isLoaded&&b.setDisabled("wsstyle",a.wsselection&&a.wsselection.withinCode());b.setActive("wsstyle",0<c(f).closest("span,div,font,strike,s").length)});a.plugins.wscommon.disableUntilLibsLoad(a,"wsstyle")},getInfo:function(){return{longname:"Wikispaces style",author:"Tangient LLC",authorurl:"/web/20130325074413/http://wikispaces.com",infourl:"/web/20130325074413/http://wikispaces.com",version:"0.1"}},applyStyle:function(){ws.common.track("Editor","Apply Style");var a=c(document.styleForm.styleText).val(),
...
a.plugins.wscommon.cursorToAndRemoveElement(c("#wsHold",a.getDoc()).get(0));h&&"\n"==g.text().substr(-1)&&(a.selection.setContent('\n<span id="wsHold"></span>'),a.plugins.wscommon.cursorToAndRemoveElement(c("#wsHold",a.getDoc()).get(0)));b.preventDefault();b.stopPropagation();return!1}}});a.plugins.wscommon.disableUntilLibsLoad(a,"wswidget")},getInfo:function(){return{longname:"Wikispaces widgets",author:"Tangient LLC",authorurl:"/web/20130325074413/http://wikispaces.com",infourl:"/web/20130325074413/http://wikispaces.com",version:"0.1"}},
...
a.onModeSwitch.add(function(a){"visual"==a?_.defer(function(){WikispacesCommentManager.showAll()}):"plain"==a&&WikispacesCommentManager.hideAll()})},getInfo:function(){return{longname:"Wikispaces comment",author:"Tangient LLC",authorurl:"/web/20130325074413/http://wikispaces.com",infourl:"/web/20130325074413/http://wikispaces.com",version:"0.1"}},isAutoSaveComments:function(a){return _(a).any(function(a){return _.isString(a)})},loadComments:function(a){this.isAutoSaveComments(a)?WikispacesCommentManager.retrieveData(function(){_(a).each(function(a,
...
jQuery("#wsMainEditor_external").css({MozUserSelect:"none",KhtmlUserSelect:"None",cursor:"default"}).bind("selectstart",function(){return!1});a=c.add(g,"div",{"class":"mceIframeContainer editorLayer active_editor",style:"position: relative;"});g=c.add(g,"div",{style:"display: none;"});return{iframeContainer:a,editorContainer:d.id+"_container",sizeContainer:g,deltaHeight:0}},getInfo:function(){return{longname:"Wikispaces theme",author:"Tangient LLC",authorurl:"/web/20130325074413/http://wikispaces.com",version:"0.1"}}});
f.ThemeManager.add("wikispaces",wikispaces.themes.WikispacesTheme)})(tinymce);
(function(f){f.create("wikispaces.plugins.ImageTextPlugin:wikispaces.plugins.ImagePlugin",{init:function(c){var a=this;this.editor=c;c.addCommand("wsimageText",function(){f.mainEditor.plugins.wspopup.show("imageTool",{plugin:a})})},getInfo:function(){return{longname:"Wikispaces image text",author:"Tangient LLC",authorurl:"/web/20130325074413/http://wikispaces.com",infourl:"/web/20130325074413/http://wikispaces.com",version:"0.1"}},insertImageInEditorCallback:function(c,a,b,d,e,f,h){(e=f)&&this.isLocalContext(f)&&(e="");"audio"==b||"video"==
...
(function(f){f.create("wikispaces.plugins.TableTextPlugin:wikispaces.plugins.TablePlugin",{init:function(c){var a=this;this.editor=c;c.addCommand("wsTableText",function(){f.mainEditor.plugins.wspopup.show("tablePopupContents",{plugin:a})})},getInfo:function(){return{longname:"Wikispaces table text",author:"Tangient LLC",authorurl:"/web/20130325074413/http://wikispaces.com",infourl:"/web/20130325074413/http://wikispaces.com",version:"0.1"}},addTable:function(c,a){ws.common.track("Editor","Add Table",c+"x"+a);for(var b="",d=0;d<c;d++){b+=
...
(function(f,c){f.create("wikispaces.plugins.LinkTextPlugin:wikispaces.plugins.LinkPlugin",{init:function(a){var b=this;this.editor=a;a.addCommand("wslinkText",function(){f.mainEditor.plugins.wspopup.show("linkTool",{plugin:b})})},getInfo:function(){return{longname:"Wikispaces link (text)",author:"Tangient LLC",authorurl:"/web/20130325074413/http://wikispaces.com",infourl:"/web/20130325074413/http://wikispaces.com",version:"0.1"}},setupForms:function(){this.editor.wsselection.restore(!0);this.editor.plugins.wstext.expandSelectionToTag("[[",
...
sizeContainer:d,deltaHeight:0}},getInfo:function(){return{longname:"Wikispaces reference theme",author:"Tangient LLC",authorurl:"/web/20130325074413/http://wikispaces.com",version:"0.1"}}});f.ThemeManager.add("reference",wikispaces.themes.ReferenceTheme)})(tinymce);
