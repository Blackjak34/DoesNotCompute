...
/*
     FILE ARCHIVED ON 16:39:46 Jan 28, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 21:18:18 Mar 8, 2015.
     JAVASCRIPT APPENDED BY WAYBACK MACHINE, COPYRIGHT INTERNET ARCHIVE.

     ALL OTHER CONTENT MAY ALSO BE PROTECTED BY COPYRIGHT (17 U.S.C.
     SECTION 108(a)(3)).
*/
/* 2:1f92f6e68593b83b27ff339f848612e9 */
...
function t(){B.forced_root_block&&f.onInit.add(function(){c("DefaultParagraphSeparator",B.forced_root_block)})}function s(){function a(b,c){(!b||!c.initial)&&f.execCommand("mceRepaint")}f.onUndo.add(a);f.onRedo.add(a);f.onSetContent.add(a)}function r(){f.onKeyDown.add(function(a,b){!b.isDefaultPrevented()&&8==b.keyCode&&"IMG"==z.getNode().nodeName&&(b.preventDefault(),a.undoManager.beforeChange(),v.remove(z.getNode()),a.undoManager.add())})}function u(){var b;10<=a()&&(b="",tinymce.each("p,div,h1,h2,h3,h4,h5,h6".split(","),
function(a,c){b=b+((c>0?",":"")+a+":empty")}),f.contentStyles.push(b+"{padding-right: 1px !important}"))}var D=tinymce.VK,x=D.BACKSPACE,A=D.DELETE,v=f.dom,z=f.selection,B=f.settings;(function(){f.onKeyDown.add(function(a,b){if(!b.isDefaultPrevented()&&b.keyCode===x&&z.isCollapsed()&&0===z.getRng(!0).startOffset){var c=z.getNode().previousSibling;if(c&&c.nodeName&&"table"===c.nodeName.toLowerCase())return tinymce.dom.Event.cancel(b)}})})();(function(){f.onKeyDown.add(function(a,b){var c,e,d,g,h;if(!(b.isDefaultPrevented()||
b.keyCode!=D.BACKSPACE))if(c=z.getRng(),e=c.startContainer,d=c.startOffset,g=v.getRoot(),h=e,c.collapsed&&0===d){for(;h&&h.parentNode&&h.parentNode.firstChild==h&&h.parentNode!=g;)h=h.parentNode;"BLOCKQUOTE"===h.tagName&&(a.formatter.toggle("blockquote",null,h),c.setStart(e,0),c.setEnd(e,0),z.setRng(c),z.collapse(!1))}})})();(function(){function a(b,c){var e,d;d=c?"start":"end";e=b[d+"Container"];d=b[d+"Offset"];1==e.nodeType&&e.hasChildNodes()&&(e=e.childNodes[Math.min(c?d:0<d?d-1:0,e.childNodes.length-
1)]);return e}function b(c,e){var d,g,h;h=e?"start":"end";var k;d=c[h+"Container"];g=c[h+"Offset"];h=v.getRoot();1==d.nodeType&&(k=g>=d.childNodes.length,d=a(c,e),3==d.nodeType&&(g=e&&!k?0:d.nodeValue.length));if(3==d.nodeType&&(e&&0<g||!e&&g<d.nodeValue.length))return!1;for(;d!==h;){g=d.parentNode[e?"firstChild":"lastChild"];"BR"==g.nodeName&&(g=g[e?"nextSibling":"previousSibling"]||g);if(g!==d)return!1;d=d.parentNode}return!0}f.onKeyDown.addToTop(function(c,e){var d;d=e.keyCode;if(!e.isDefaultPrevented()&&
(d==A||d==x))if(d=z.getRng(!0),b(d,!0)&&b(d,!1)&&(d.collapsed||v.findCommonAncestor(a(d,!0),a(d))===v.getRoot()))c.setContent(""),c.nodeChanged(),e.preventDefault()})})();tinymce.isWebKit&&(o(),b(),d(),h(),t(),tinymce.isIDevice&&l());tinymce.isIE&&(e(),document.body.setAttribute("role","application"),m(),n(),r(),u());tinymce.isGecko&&(e(),g(),k(),p(),q(),s())};
(function(f){function c(a,c){var e,d,g,h={};if(a){a=a.split(",");c=c||10;for(e=0;e<a.length;e+=2)d=String.fromCharCode(parseInt(a[e],c)),b[d]||(g="&"+a[e+1]+";",h[d]=g,h[g]=d);return h}}var a,b,d,e=/[&<>\"\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g,g=/[<>&\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g,h=/[<>&\"\']/g,k=/&(#x|#)?([\w]+);/g,l={128:"\u20ac",130:"\u201a",131:"\u0192",132:"\u201e",133:"\u2026",134:"\u2020",135:"\u2021",136:"\u02c6",137:"\u2030",138:"\u0160",
...
function t(a,b){A&&(a=a.replace(/\uFEFF[0-9]/g,function(a){return k[a]}));b||(a=a.replace(/\\([\'\";:])/g,"$1"));return a}function s(a,b,c,e,d,g){if(d=d||g)return d=t(d),"'"+d.replace(/\'/g,"\\'")+"'";b=t(b||c||e);v&&(b=v.call(z,b,"style"));return"url('"+b.replace(/\'/g,"\\'")+"')"}var r={},u,D,x,A,v=f.url_converter,z=f.url_converter_scope||this;if(c){for(c=c.replace(/\\[\"\';:\uFEFF]/g,q).replace(/\"[^\"]+\"|\'[^\']+\'/g,function(a){return a.replace(/[;:]/g,q)});u=e.exec(c);){D=u[1].replace(g,"").toLowerCase();
x=u[2].replace(g,"");if(D&&0<x.length){if("font-weight"===D&&"700"===x)x="bold";else if("color"===D||"background-color"===D)x=x.toLowerCase();x=x.replace(b,a);x=x.replace(d,s);r[D]=A?t(x,!0):x}e.lastIndex=u.index+u[0].length}h("border","");h("border","-width");h("border","-color");h("border","-style");h("padding","");h("margin","");l("border","border-width","border-style","border-color");"medium none"===r.border&&delete r.border}return r},serialize:function(a,b){function e(b){var g,h,k,f;if(g=c.styles[b]){h=
0;for(k=g.length;h<k;h++)b=g[h],f=a[b],void 0!==f&&0<f.length&&(d+=(0<d.length?" ":"")+b+": "+f+";")}}var d="",g,h;if(b&&c&&c.styles)e("*"),e(b);else for(g in a)h=a[g],void 0!==h&&0<h.length&&(d+=(0<d.length?" ":"")+g+": "+h+";");return d}}};
...
return b}var e={},g=f.makeMap,h=f.each;f.html.Schema=function(a){function l(b,c,d){var h=a[b];h?h=g(h,",",g(h.toUpperCase()," ")):(h=e[b],h||(h=g(c," ",g(c.toUpperCase()," ")),h=f.extend(h,d),e[b]=h));return h}function m(a){var b,e,d,h,k,o,n,l,m,p,s,q,u,x,D,A,v,z,B=/^([#+\-])?([^\[\/]+)(?:\/([^\[]+))?(?:\[([^\]]+)\])?$/,C=/^([!\-])?(\w+::\w+|[^=:<]+)?(?:([=:<])(.*))?$/,E=/[*?+]/;if(a){a=c(a);t["@"]&&(A=t["@"].attributes,v=t["@"].attributesOrder);b=0;for(e=a.length;b<e;b++)if(k=B.exec(a[b])){x=k[1];
m=k[2];D=k[3];l=k[4];q={};u=[];o={attributes:q,attributesOrder:u};"#"===x&&(o.paddEmpty=!0);"-"===x&&(o.removeEmpty=!0);if(A){for(z in A)q[z]=A[z];u.push.apply(u,v)}if(l){l=c(l,"|");d=0;for(h=l.length;d<h;d++)if(k=C.exec(l[d]))if(n={},s=k[1],p=k[2].replace(/::/g,":"),x=k[3],k=k[4],"!"===s&&(o.attributesRequired=o.attributesRequired||[],o.attributesRequired.push(p),n.required=!0),"-"===s)delete q[p],u.splice(f.inArray(u,p),1);else{if(x&&("="===x&&(o.attributesDefault=o.attributesDefault||[],o.attributesDefault.push({name:p,
value:k}),n.defaultValue=k),":"===x&&(o.attributesForced=o.attributesForced||[],o.attributesForced.push({name:p,value:k}),n.forcedValue=k),"<"===x))n.validValues=g(k,"?");E.test(p)?(o.attributePatterns=o.attributePatterns||[],n.pattern=RegExp("^"+p.replace(/([?+*])/g,".$1")+"$"),o.attributePatterns.push(n)):(q[p]||u.push(p),q[p]=n)}}!A&&"@"==m&&(A=q,v=u);D&&(o.outputName=m,t[D]=o);E.test(m)?(o.pattern=RegExp("^"+m.replace(/([?+*])/g,".$1")+"$"),r.push(o)):t[m]=o}}}function n(a){t={};r=[];m(a);h(D,
function(a,b){s[b]=a.children})}function o(a){var b=/^(~)?(.+)$/;a&&h(c(a),function(a){var a=b.exec(a),c="~"===a[1],e=c?"span":"div",d=a[2];s[d]=s[e];C[d]=e;c||(B[d]={});h(s,function(a){a[e]&&(a[d]=a[e])})})}function p(a){var b=/^([+\-]?)(\w+)\[([^\]]+)\]$/;a&&h(c(a),function(a){var a=b.exec(a),e,d;a&&(e=(d=a[1])?s[a[2]]:s[a[2]]={"#comment":{}},e=s[a[2]],h(c(a[3],"|"),function(a){"-"===d?delete e[a]:e[a]={}}))})}function q(a){var b=t[a],c;if(b)return b;for(c=r.length;c--;)if(b=r[c],b.pattern.test(a))return b}
var t={},s={},r=[],u,D,x,A,v,z,B,E,C={},a=a||{};D="html5"==a.schema?b():d();!1===a.verify_html&&(a.valid_elements="*[*]");a.valid_styles&&(u={},h(a.valid_styles,function(a,b){u[b]=f.explode(a)}));x=l("whitespace_elements","pre script style textarea");A=l("self_closing_elements","colgroup dd dt li option p td tfoot th thead tr");v=l("short_ended_elements","area base basefont br col frame hr img input isindex link meta param embed source");z=l("boolean_attributes","checked compact declare defer disabled ismap multiple nohref noresize noshade nowrap readonly selected autoplay loop controls");
E=l("non_empty_elements","td th iframe video audio object",v);B=l("block_elements","h1 h2 h3 h4 h5 h6 hr p div address pre form table tbody thead tfoot th tr td li ol ul caption blockquote center dl dt dd dir fieldset noscript menu isindex samp header footer article section hgroup aside nav figure option datalist select optgroup");a.valid_elements?n(a.valid_elements):(h(D,function(a,b){t[b]={attributes:a.attributes,attributesOrder:a.attributesOrder};s[b]=a.children}),"html5"!=a.schema&&h(c("strong/b,em/i"),
function(a){a=c(a,"/");t[a[1]].outputName=a[0]}),t.img.attributesDefault=[{name:"alt",value:""}],h(c("ol,ul,sub,sup,blockquote,span,font,a,table,tbody,tr,strong,em,b,i"),function(a){if(t[a])t[a].removeEmpty=true}),h(c("p,h1,h2,h3,h4,h5,h6,th,td,pre,div,address,caption"),function(a){t[a].paddEmpty=true}));o(a.custom_elements);p(a.valid_children);m(a.extended_valid_elements);p("+ol[ul|ol],+ul[ul|ol]");a.invalid_elements&&f.each(f.explode(a.invalid_elements),function(a){t[a]&&delete t[a]});q("span")||
m("span[!data-mce-type|*]");this.children=s;this.styles=u;this.getBoolAttrs=function(){return z};this.getBlockElements=function(){return B};this.getShortEndedElements=function(){return v};this.getSelfClosingElements=function(){return A};this.getNonEmptyElements=function(){return E};this.getWhiteSpaceElements=function(){return x};this.isValidChild=function(a,b){var c=s[a];return!(!c||!c[b])};this.isValid=function(a,b){var c,e;if(c=q(a))if(b){if(c.attributes[b])return true;if(c=c.attributePatterns)for(e=
...
0){a=y[b];if(!a&&F){for(e=F.length;e--;){a=F[e];if(a.pattern.test(b))break}e===-1&&(a=null)}if(!a||a.validValues&&!(c in a.validValues))return}q.map[b]=c;q.push({name:b,value:c})}var k=this,l,m=0,n,o,p=[],q,t,s,r,u,D,x,A,v,z,B,E,C,y,F,G,L,O,H,M,K,N,T=0,J=f.html.Entities.decode,I,P;M=RegExp("<(?:(?:!--([\\w\\W]*?)--\>)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))",
...
P&&C.test(n)&&(n=n.substr(1));m=n in D;I&&H[n]&&p.length>0&&p[p.length-1].name===n&&d(n);if(!A||(v=a.getElementRule(n))){z=true;if(A){y=v.attributes;F=v.attributePatterns}if(E=l[8]){(r=E.indexOf("data-mce-type")!==-1)&&u&&(z=false);q=[];q.map={};E.replace(K,h)}else{q=[];q.map={}}if(A&&!r){G=v.attributesRequired;L=v.attributesDefault;if(O=v.attributesForced)for(o=O.length;o--;){B=O[o];s=B.name;B=B.value;B==="{$uid}"&&(B="mce_"+T++);q.map[s]=B;q.push({name:s,value:B})}if(L)for(o=L.length;o--;){B=L[o];
s=B.name;if(!(s in q.map)){B=B.value;B==="{$uid}"&&(B="mce_"+T++);q.map[s]=B;q.push({name:s,value:B})}}if(G){for(o=G.length;o--;)if(G[o]in q.map)break;o===-1&&(z=false)}q.map["data-mce-bogus"]&&(z=false)}z&&k.start(n,q,m)}else z=false;if(o=N[n]){o.lastIndex=m=l.index+l[0].length;if(l=o.exec(b)){z&&(t=b.substr(m,l.index-m));m=l.index+l[0].length}else{t=b.substr(m);m=b.length}z&&t.length>0&&k.text(t,true);z&&k.end(n);M.lastIndex=m;continue}m||(!E||E.indexOf("/")!=E.length-1?p.push({name:n,valid:z}):
...
(function(f){var c=f.html.Node;f.html.DomParser=function(a,b){function d(a){var d,g,h,k,l,s,r,u,D,x,A;x=f.makeMap("tr,td,th,tbody,thead,tfoot,table");D=b.getNonEmptyElements();for(d=0;d<a.length;d++)if(g=a[d],g.parent){k=[g];for(h=g.parent;h&&!b.isValidChild(h.name,g.name)&&!x[h.name];h=h.parent)k.push(h);if(h&&1<k.length){k.reverse();l=s=e.filterNode(k[0].clone());for(u=0;u<k.length-1;u++){b.isValidChild(s.name,k[u].name)?(r=e.filterNode(k[u].clone()),s.append(r)):r=s;for(s=k[u].firstChild;s&&s!=
k[u+1];)A=s.next,r.append(s),s=A;s=r}l.isEmpty(D)?h.insert(g,k[0],!0):(h.insert(l,k[0],!0),h.insert(g,l));h=k[0];(h.isEmpty(D)||h.firstChild===h.lastChild&&"br"===h.firstChild.name)&&h.empty().remove()}else g.parent&&("li"===g.name?(h=g.prev)&&("ul"===h.name||"ul"===h.name)?h.append(g):(h=g.next)&&("ul"===h.name||"ul"===h.name)?h.insert(g,h.firstChild,!0):g.wrap(e.filterNode(new c("ul",1))):b.isValidChild(g.parent.name,"div")&&b.isValidChild("div",g.name)?g.wrap(e.filterNode(new c("div",1))):"style"===
g.name||"script"===g.name?g.empty().remove():g.unwrap())}}var e=this,g={},h=[],k={},l={},a=a||{};a.validate="validate"in a?a.validate:!0;a.root_name=a.root_name||"body";e.schema=b=b||new f.html.Schema;e.filterNode=function(a){var b,c,d;c in g&&((d=k[c])?d.push(a):k[c]=[a]);for(b=h.length;b--;)c=h[b].name,c in a.attributes.map&&((d=l[c])?d.push(a):l[c]=[a]);return a};e.addNodeFilter=function(a,b){f.each(f.explode(a),function(a){var c=g[a];c||(g[a]=c=[]);c.push(b)})};e.addAttributeFilter=function(a,
b){f.each(f.explode(a),function(a){var c;for(c=0;c<h.length;c++)if(h[c].name===a){h[c].callbacks.push(b);return}h.push({name:a,callbacks:[b]})})};e.parse=function(e,n){function o(){for(var a=s.firstChild,b,c;a;)b=a.next,3==a.type||1==a.type&&"p"!==a.name&&!B[a.name]&&!a.attr("data-mce-type")?(c||(c=p(K,1),s.insert(c,a)),c.append(a)):c=null,a=b}function p(a,b){var d=new c(a,b),e;a in g&&((e=k[a])?e.push(d):k[a]=[d]);return d}function q(a){for(var b,a=a.prev;a&&3===a.type;)b=a.value.replace(F,""),0<
b.length?(a.value=b,a=a.prev):(b=a.prev,a.remove(),a=b)}var t,s,r,u,D,x,A,v,z,B,E,C=[],y,F,G,L,O,H,M,K,n=n||{};k={};l={};B=f.extend(f.makeMap("script,style,head,html,body,title,meta,param"),b.getBlockElements());M=b.getNonEmptyElements();H=b.children;z=a.validate;K="forced_root_block"in n?n.forced_root_block:a.forced_root_block;O=b.getWhiteSpaceElements();E=/^[ \t\r\n]+/;F=/[ \t\r\n]+$/;G=/[ \t\r\n]+/g;L=/^[ \t\r\n]+$/;t=new f.html.SaxParser({validate:z,self_closing_elements:function(a){var b,c={};
...
{}){e=p(e.outputName||a,1);e.attributes=c;e.shortEnded=d;r.append(e);(g=H[r.name])&&H[e.name]&&!g[e.name]&&C.push(e);for(g=h.length;g--;)k=h[g].name,k in c.map&&((v=l[k])?v.push(e):l[k]=[e]);B[a]&&q(e);d||(r=e);!y&&O[a]&&(y=!0)}},end:function(a){var d,e,g,h;if(e=z?b.getElementRule(a):{}){if(B[a]){if(!y){if((d=r.firstChild)&&3===d.type){g=d.value.replace(E,"");0<g.length?(d.value=g,d=d.next):(h=d.next,d.remove(),d=h);for(;d&&3===d.type;)g=d.value,h=d.next,(0===g.length||L.test(g))&&d.remove(),d=h}if((d=
r.lastChild)&&3===d.type){g=d.value.replace(F,"");0<g.length?(d.value=g,d=d.prev):(h=d.prev,d.remove(),d=h);for(;d&&3===d.type;)g=d.value,h=d.prev,(0===g.length||L.test(g))&&d.remove(),d=h}}if((d=r.prev)&&3===d.type)g=d.value.replace(E,""),0<g.length?d.value=g:d.remove()}y&&O[a]&&(y=!1);if((e.removeEmpty||e.paddEmpty)&&r.isEmpty(M))if(e.paddEmpty)r.empty().append(new c("#text","3")).value="\u00a0";else if(!r.attributes.map.name&&!r.attributes.map.id){a=r.parent;r.empty().remove();r=a;return}r=r.parent}}},
b);s=r=new c(n.context||a.root_name,11);t.parse(e);z&&C.length&&(n.context?n.invalid=!0:d(C));K&&"body"==s.name&&o();if(!n.invalid){for(A in k){v=g[A];t=k[A];for(x=t.length;x--;)t[x].parent||t.splice(x,1);u=0;for(D=v.length;u<D;u++)v[u](t,A,n)}u=0;for(D=h.length;u<D;u++)if(v=h[u],v.name in l){t=l[v.name];for(x=t.length;x--;)t[x].parent||t.splice(x,1);x=0;for(A=v.callbacks.length;x<A;x++)v.callbacks[x](t,v.name,n)}}return s};a.remove_trailing_brs&&e.addNodeFilter("br",function(a){var c,d=a.length,
e,g=f.extend({},b.getBlockElements()),h=b.getNonEmptyElements(),k,l,u;g.body=1;for(c=0;c<d;c++)if(e=a[c],k=e.parent,g[e.parent.name]&&e===k.lastChild){for(l=e.prev;l;){u=l.name;if("span"!==u||"bookmark"!==l.attr("data-mce-type")){if("br"!==u)break;if("br"===u){e=null;break}}l=l.prev}if(e&&(e.remove(),k.isEmpty(h)&&(elementRule=b.getElementRule(k.name))))elementRule.removeEmpty?k.remove():elementRule.paddEmpty&&(k.empty().append(new f.html.Node("#text",3)).value="\u00a0")}else{for(l=e;k.firstChild===
l&&k.lastChild===l;){l=k;if(g[k.name])break;k=k.parent}l===k&&(textNode=new f.html.Node("#text",3),textNode.value="\u00a0",e.replace(textNode))}});a.allow_html_in_named_anchor||e.addAttributeFilter("id,name",function(a){for(var b=a.length,c,d,e,g;b--;)if(g=a[b],"a"===g.name&&g.firstChild&&!g.attr("href")){e=g.parent;c=g.lastChild;do d=c.prev,e.insert(c,g),c=d;while(c)}})}})(tinymce);
...
"")}}};
(function(f){f.html.Serializer=function(c,a){var b=new f.html.Writer(c),c=c||{};c.validate="validate"in c?c.validate:!0;this.schema=a=a||new f.html.Schema;this.writer=b;this.serialize=function(d){function e(c){var d=g[c.type],f,n,o,p,q,t,s,r;if(d)d(c);else{d=c.name;f=c.shortEnded;n=c.attributes;if(h&&n&&1<n.length){q=[];q.map={};r=a.getElementRule(c.name);t=0;for(s=r.attributesOrder.length;t<s;t++)o=r.attributesOrder[t],o in n.map&&(p=n.map[o],q.map[o]=p,q.push({name:o,value:p}));t=0;for(s=n.length;t<
s;t++)o=n[t].name,o in q.map||(p=n.map[o],q.map[o]=p,q.push({name:o,value:p}));n=q}b.start(c.name,n,f);if(!f){if(c=c.firstChild){do e(c);while(c=c.next)}b.end(d)}}}var g,h;h=c.validate;g={3:function(a){b.text(a.value,a.raw)},8:function(a){b.comment(a.value)},7:function(a){b.pi(a.name,a.value)},10:function(a){b.doctype(a.value)},4:function(a){b.cdata(a.value)},11:function(a){if(a=a.firstChild){do e(a);while(a=a.next)}}};b.reset();if(1==d.type&&!c.inner)e(d);else g[11](d);return b.getContent()}}})(tinymce);
tinymce.dom={};
(function(f,c){function a(a,b,c,d){a.addEventListener?a.addEventListener(b,c,d||!1):a.attachEvent&&a.attachEvent("on"+b,c)}function b(a,b,c,d){a.removeEventListener?a.removeEventListener(b,c,d||!1):a.detachEvent&&a.detachEvent("on"+b,c)}function d(a,b){function c(){return!1}function d(){return!0}var e,g=b||{};for(e in a)"layerX"!==e&&"layerY"!==e&&(g[e]=a[e]);g.target||(g.target=g.srcElement||document);g.preventDefault=function(){g.isDefaultPrevented=d;if(a)a.preventDefault?a.preventDefault():a.returnValue=
false};g.stopPropagation=function(){g.isPropagationStopped=d;if(a)a.stopPropagation?a.stopPropagation():a.cancelBubble=true};g.stopImmediatePropagation=function(){g.isImmediatePropagationStopped=d;g.stopPropagation()};g.isDefaultPrevented||(g.isDefaultPrevented=c,g.isPropagationStopped=c,g.isImmediatePropagationStopped=c);return g}function e(c,d,e){function g(){e.domLoaded||(e.domLoaded=!0,d(p))}var f=c.document,p={type:"ready"};h?a(c,"DOMContentLoaded",g):(a(f,"readystatechange",function(){"complete"===
f.readyState&&(b(f,"readystatechange",arguments.callee),g())}),f.documentElement.doScroll&&c===c.top&&function(){try{f.documentElement.doScroll("left")}catch(a){setTimeout(arguments.callee,0);return}g()}());a(c,"load",g)}function g(g){function f(a,b){var c,d,e,g;if(c=n[b][a.type]){d=0;for(e=c.length;d<e&&!((g=c[d])&&!1===g.func.call(g.scope,a)&&a.preventDefault(),a.isImmediatePropagationStopped());d++);}}var m=this,n={},o,p,q,t;q="onmouseenter"in document.documentElement;p="onfocusin"in document.documentElement;
t={mouseenter:"mouseover",mouseleave:"mouseout"};o=1;m.domLoaded=!1;m.events=n;m.bind=function(b,r,u,D){function x(a){f(d(a||F.event),A)}var A,v,z,B,E,C,y,F=window;if(b&&!(3===b.nodeType||8===b.nodeType)){b[c]?(A=b[c],n[A]||(n[A]={})):(A=o++,b[c]=A,n[A]={});D=D||b;r=r.split(" ");for(z=r.length;z--;)if(B=r[z],C=x,E=y=!1,"DOMContentLoaded"===B&&(B="ready"),(m.domLoaded||"complete"==b.readyState)&&"ready"===B)m.domLoaded=!0,u.call(D,d({type:B}));else{q||(E=t[B])&&(C=function(a){var b,c;b=a.currentTarget;
...
if(this.hasClass(a,b))return a.className;c=this.removeClass(a,b);return a.className=(""!=c?c+" ":"")+b})},removeClass:function(a,b){var c=this,d;return c.run(a,function(a){var e;return c.hasClass(a,b)?(d||(d=RegExp("(^|\\s+)"+b+"(\\s+|$)","g")),e=a.className.replace(d," "),e=f.trim(" "!=e?e:""),a.className=e,e||(a.removeAttribute("class"),a.removeAttribute("className")),e):a.className})},hasClass:function(a,b){a=this.get(a);return!a||!b?!1:-1!==(" "+a.className+" ").indexOf(" "+b+" ")},show:function(a){return this.setStyle(a,
...
a.nodeType)if(c=c||a.ownerDocument||g.doc,d)try{d&&1==a.nodeType?a.outerHTML=b:e(a,b,c)}catch(h){e(a,b,c)}else e(a,b,c)})},decode:e.decode,encode:e.encodeAllRaw,insertAfter:function(a,b){b=this.get(b);return this.run(a,function(a){var c,d;c=b.parentNode;(d=b.nextSibling)?c.insertBefore(a,d):c.appendChild(a);return a})},replace:function(b,d,e){a(d,"array")&&(b=b.cloneNode(!0));return this.run(d,function(a){e&&c(f.grep(a.childNodes),function(a){b.appendChild(a)});return a.parentNode.replaceChild(b,
a)})},rename:function(a,b){var d=this,e;a.nodeName!=b.toUpperCase()&&(e=d.create(b),c(d.getAttribs(a),function(b){d.setAttrib(e,b.nodeName,d.getAttrib(a,b.nodeName))}),d.replace(e,a,1));return e||a},findCommonAncestor:function(a,b){for(var c=a,d;c;){for(d=b;d&&c!=d;)d=d.parentNode;if(c==d)break;c=c.parentNode}return!c&&a.ownerDocument?a.ownerDocument.documentElement:c},toHex:function(a){function b(a){a=parseInt(a,10).toString(16);return 1<a.length?a:"0"+a}var c=/^\s*rgb\s*?\(\s*?([0-9]+)\s*?,\s*?([0-9]+)\s*?,\s*?([0-9]+)\s*?\)\s*$/i.exec(a);
c&&(a="#"+b(c[1])+b(c[2])+b(c[3]));return a},getClasses:function(){function a(o){c(o.imports,function(b){a(b)});c(o.cssRules||o.rules,function(o){switch(o.type||1){case 1:o.selectorText&&c(o.selectorText.split(","),function(a){a=a.replace(/^\s*|\s*$|^\s\./g,"");if(!/\.mce/.test(a)&&/\.[\w\-]+$/.test(a)&&(g=a,a=f._replace(/.*\.([a-z0-9_\-]+).*/i,"$1",a),(!e||(a=e(a,g)))&&!d[a]))b.push({"class":a}),d[a]=1});break;case 3:a(o.styleSheet)}})}var b=[],d={},e=this.settings.class_filter,g;if(this.classes)return this.classes;
try{c(this.doc.styleSheets,a)}catch(o){}0<b.length&&(this.classes=b);return b},run:function(a,b,d){var e=this,g;e.doc&&"string"===typeof a&&(a=e.get(a));if(!a)return!1;d=d||this;return!a.nodeType&&(a.length||0===a.length)?(g=[],c(a,function(a,c){a&&("string"==typeof a&&(a=e.doc.getElementById(a)),g.push(b.call(d,a,c)))}),g):b.call(d,a)},getAttribs:function(a){var b,a=this.get(a);if(!a)return[];if(d){b=[];if("OBJECT"==a.nodeName)return a.attributes;"OPTION"===a.nodeName&&this.getAttrib(a,"selected")&&
b.push({specified:1,nodeName:"selected"});a.cloneNode(!1).outerHTML.replace(/<\/?[\w:\-]+ ?|=[\"][^\"]+\"|=\'[^\']+\'|=[\w\-]+|>/gi,"").replace(/[\w:\-]+/gi,function(a){b.push({specified:1,nodeName:a})});return b}return a.attributes},isEmpty:function(a,b){var c,d,e,o,p=0;if(a=a.firstChild){e=new f.dom.TreeWalker(a,a.parentNode);b=b||this.schema?this.schema.getNonEmptyElements():null;do{d=a.nodeType;if(1===d){if(a.getAttribute("data-mce-bogus"))continue;o=a.nodeName.toLowerCase();if(b&&b[o]){if("br"===
o){p++;continue}return!1}this.getAttribs(a);for(c=a.attributes.length;c--;)if(o=a.attributes[c].nodeName,"name"===o||"data-mce-bookmark"===o)return!1}if(8==d||3===d&&!g.test(a.nodeValue))return!1}while(a=e.next())}return 1>=p},destroy:function(a){this.win=this.doc=this.root=this.events=this.frag=null;a||f.removeUnload(this.destroy)},createRng:function(){var a=this.doc;return a.createRange?a.createRange():new f.dom.Range(this)},nodeIndex:function(a,b){var c=0,d,e;if(a){d=a.nodeType;for(a=a.previousSibling;a;a=
a.previousSibling)if(e=a.nodeType,!(b&&3==e)||e!=d&&a.nodeValue.length)c++,d=e}return c},split:function(a,b,c){function d(a){var b,c=a.childNodes,g=a.nodeType;if(!(1==g&&"bookmark"==a.getAttribute("data-mce-type"))){for(b=c.length-1;0<=b;b--)d(c[b]);if(9!=g){if(3==g&&0<a.nodeValue.length){b=f.trim(a.nodeValue).length;if(!(c=!e.isBlock(a.parentNode)))if(!(c=0<b)){if(b=0===b)b=a.nextSibling&&"SPAN"==a.nextSibling.nodeName,b=a.previousSibling&&"SPAN"==a.previousSibling.nodeName&&b;c=b}if(c)return}else if(1==
g&&(c=a.childNodes,1==c.length&&c[0]&&1==c[0].nodeType&&"bookmark"==c[0].getAttribute("data-mce-type")&&a.parentNode.insertBefore(c[0],a),c.length||/^(br|hr|input|img)$/i.test(a.nodeName)))return;e.remove(a)}return a}}var e=this,g=e.createRng(),p,q;if(a&&b)return g.setStart(a.parentNode,e.nodeIndex(a)),g.setEnd(b.parentNode,e.nodeIndex(b)),p=g.extractContents(),g=e.createRng(),g.setStart(b.parentNode,e.nodeIndex(b)+1),g.setEnd(a.parentNode,e.nodeIndex(a)+1),g=g.extractContents(),q=a.parentNode,q.insertBefore(d(p),
a),c?q.replaceChild(c,b):q.insertBefore(b,a),q.insertBefore(d(g),a),e.remove(a),c||b},bind:function(a,b,c,d){return this.events.add(a,b,c,d||this)},unbind:function(a,b,c){return this.events.remove(a,b,c)},fire:function(a,b,c){return this.events.fire(a,b,c)},getContentEditable:function(a){var b;return 1!=a.nodeType?null:(b=a.getAttribute("data-mce-contenteditable"))&&"inherit"!==b?b:"inherit"!==a.contentEditable?a.contentEditable:null},_findSib:function(b,c,d){var e=this,g=c;if(b){a(g,"string")&&(g=
function(a){return e.is(a,c)});for(b=b[d];b;b=b[d])if(g(b))return b}return null},_isRes:function(a){return/^(top|left|bottom|right|width|height)/i.test(a)||/;\s*(top|left|bottom|right|width|height)/i.test(a)}});f.DOM=new f.dom.DOMUtils(document,{process_html:0})})(tinymce);
(function(f){function c(a){function b(a,b){m(A,a,b)}function d(a,b){m(v,a,b)}function e(a){b(a.parentNode,F(a))}function g(a){d(a.parentNode,F(a)+1)}function h(){return n(D)}function f(a,b){var c;if(3==a.nodeType||0>b)return a;for(c=a.firstChild;c&&0<b;)--b,c=c.nextSibling;return c?c:a}function l(b,c,d,e){var g,h;if(b==d)return c==e?0:c<e?-1:1;for(g=d;g&&g.parentNode!=b;)g=g.parentNode;if(g){h=0;for(d=b.firstChild;d!=g&&h<c;)h++,d=d.nextSibling;return c<=h?-1:1}for(g=b;g&&g.parentNode!=d;)g=g.parentNode;
if(g){h=0;for(d=d.firstChild;d!=g&&h<e;)h++,d=d.nextSibling;return h<e?-1:1}for(c=a.findCommonAncestor(b,d);b&&b.parentNode!=c;)b=b.parentNode;b||(b=c);for(e=d;e&&e.parentNode!=c;)e=e.parentNode;e||(e=c);if(b==e)return 0;for(d=c.firstChild;d;){if(d==b)return-1;if(d==e)return 1;d=d.nextSibling}}function m(b,c,d){b?(r[B]=c,r[z]=d):(r[E]=c,r[C]=d);for(c=r[E];c.parentNode;)c=c.parentNode;for(d=r[B];d.parentNode;)d=d.parentNode;d==c?0<l(r[B],r[z],r[E],r[C])&&r.collapse(b):r.collapse(b);r.collapsed=r[B]==
r[E]&&r[z]==r[C];r.commonAncestorContainer=a.findCommonAncestor(r[B],r[E])}function n(a){var b,c=0,d=0,e;if(r[B]==r[E])return o(a);b=r[E];for(e=b.parentNode;e;b=e,e=e.parentNode){if(e==r[B]){var g=b;e=d=c=e=b=void 0;a!=x&&(b=u.createDocumentFragment());e=p(g,a);b&&b.appendChild(e);c=F(g)-r[z];if(!(0>=c))for(e=g.previousSibling;0<c;)d=e.previousSibling,e=s(e,a),b&&b.insertBefore(e,b.firstChild),--c,e=d;a!=D&&(r.setEndBefore(g),r.collapse(v));a=b;return a}++c}b=r[B];for(e=b.parentNode;e;b=e,e=e.parentNode){if(e==
r[E]){g=b;e=d=c=e=c=b=void 0;a!=x&&(b=u.createDocumentFragment());e=q(g,a);b&&b.appendChild(e);c=F(g);++c;c=r[C]-c;for(e=g.nextSibling;e&&0<c;)d=e.nextSibling,e=s(e,a),b&&b.appendChild(e),--c,e=d;a!=D&&(r.setStartAfter(g),r.collapse(A));return b}++d}d-=c;for(b=r[B];0<d;)b=b.parentNode,d--;for(c=r[E];0>d;)c=c.parentNode,d++;d=b.parentNode;for(e=c.parentNode;d!=e;d=d.parentNode,e=e.parentNode)b=d,c=e;var h;a!=x&&(g=u.createDocumentFragment());h=q(b,a);g&&g.appendChild(h);d=F(b);e=F(c);++d;d=e-d;for(h=
b.nextSibling;0<d;)e=h.nextSibling,h=s(h,a),g&&g.appendChild(h),h=e,--d;h=p(c,a);g&&g.appendChild(h);a!=D&&(r.setStartAfter(b),r.collapse(A));return g}function o(a){var b,c,d,e,g;a!=x&&(b=u.createDocumentFragment());if(r[z]==r[C])return b;if(3==r[B].nodeType){c=r[B].nodeValue;d=c.substring(r[z],r[C]);a!=D&&(c=r[B],e=r[z],g=r[C]-r[z],0===e&&g>=c.nodeValue.length-1?c.parentNode.removeChild(c):c.deleteData(e,g),r.collapse(A));if(a==x)return;0<d.length&&b.appendChild(u.createTextNode(d));return b}c=f(r[B],
r[z]);for(d=r[C]-r[z];c&&0<d;)e=c.nextSibling,c=s(c,a),b&&b.appendChild(c),--d,c=e;a!=D&&r.collapse(A);return b}function p(a,b){var c=f(r[E],r[C]-1),d,e,g,h=c!=r[E];if(c==a)return t(c,h,v,b);d=c.parentNode;for(e=t(d,v,v,b);d;){for(;c;)g=c.previousSibling,c=t(c,h,v,b),b!=x&&e.insertBefore(c,e.firstChild),h=A,c=g;if(d==a)return e;c=d.previousSibling;d=d.parentNode;g=t(d,v,v,b);b!=x&&g.appendChild(e);e=g}}function q(a,b){var c=f(r[B],r[z]),d=c!=r[B],e,g,h;if(c==a)return t(c,d,A,b);e=c.parentNode;for(g=
t(e,v,A,b);e;){for(;c;)h=c.nextSibling,c=t(c,d,A,b),b!=x&&g.appendChild(c),d=A,c=h;if(e==a)return g;c=e.nextSibling;e=e.parentNode;h=t(e,v,A,b);b!=x&&h.appendChild(g);g=h}}function t(b,c,d,e){var g;if(c)return s(b,e);if(3==b.nodeType){c=b.nodeValue;d?(g=r[z],d=c.substring(g),c=c.substring(0,g)):(g=r[C],d=c.substring(0,g),c=c.substring(g));e!=D&&(b.nodeValue=c);if(e==x)return;b=a.clone(b,v);b.nodeValue=d;return b}return e==x?void 0:a.clone(b,v)}function s(b,c){if(c!=x)return c==D?a.clone(b,A):b;b.parentNode.removeChild(b)}
...
(function(){tinymce.dom.TridentSelection=function(f){function c(a,b){var c,d=0,l,m,n,o,p,q=-1,t;c=a.duplicate();c.collapse(b);t=c.parentElement();if(t.ownerDocument===f.dom.doc){for(;"false"===t.contentEditable;)t=t.parentNode;if(!t.hasChildNodes())return{node:t,inside:1};n=t.children;for(l=n.length-1;d<=l;)if(p=Math.floor((d+l)/2),o=n[p],c.moveToElementText(o),q=c.compareEndPoints(b?"StartToStart":"EndToEnd",a),0<q)l=p-1;else if(0>q)d=p+1;else return{node:o};if(0>q){o?c.collapse(!1):(c.moveToElementText(t),
c.collapse(!0),o=t,m=!0);for(d=0;0!==c.compareEndPoints(b?"StartToStart":"StartToEnd",a)&&!(0===c.move("character",1)||t!=c.parentElement());)d++}else{c.collapse(!0);for(d=0;0!==c.compareEndPoints(b?"StartToStart":"StartToEnd",a)&&!(0===c.move("character",-1)||t!=c.parentElement());)d++}return{node:o,position:q,offset:d,inside:m}}}var a=this,b=f.dom,d=!1;this.getBookmark=function(a){function d(a){var c,e,g,h,f=[];c=a.parentNode;for(e=b.getRoot().parentNode;c!=e&&9!==c.nodeType;){g=c.children;for(h=
g.length;h--;)if(a===g[h]){f.push(h);break}a=c;c=c.parentNode}return f}function h(a){if(a=c(k,a))return{position:a.position,offset:a.offset,indexes:d(a.node),inside:a.inside}}var k=f.getRng(),l={};2===a&&(k.item?l.start={ctrl:!0,indexes:d(k.item(0))}:(l.start=h(!0),f.isCollapsed()||(l.end=h())));return l};this.moveToBookmark=function(a){function c(a){var d,e,g,h;d=b.getRoot();for(e=a.length-1;0<=e;e--)h=d.children,g=a[e],g<=h.length-1&&(d=h[g]);return d}function d(b){var h=a[b?"start":"end"],o,p;
h&&(o=0<h.position,p=l.createTextRange(),p.moveToElementText(c(h.indexes)),offset=h.offset,void 0!==offset?(p.collapse(h.inside||o),p.moveStart("character",o?-offset:offset)):p.collapse(b),f.setEndPoint(b?"StartToStart":"EndToStart",p),b&&f.collapse(!0))}var f,l=b.doc.body;a.start&&(a.start.ctrl?(f=l.createControlRange(),f.addElement(c(a.start.indexes))):(f=l.createTextRange(),d(!0),d()),f.select())};this.addRange=function(a){function c(a){var e,g,f,k,t;f=b.create("a");e=a?l:n;g=a?m:o;k=h.duplicate();
if(e==p||e==p.documentElement)e=q,g=0;3==e.nodeType?(e.parentNode.insertBefore(f,e),k.moveToElementText(f),k.moveStart("character",g),b.remove(f),h.setEndPoint(a?"StartToStart":"EndToEnd",k)):(t=e.childNodes,t.length?(g>=t.length?b.insertAfter(f,t[t.length-1]):e.insertBefore(f,t[g]),k.moveToElementText(f)):e.canHaveHTML&&(e.innerHTML="<span>\ufeff</span>",f=e.firstChild,k.moveToElementText(f),k.collapse(d)),h.setEndPoint(a?"StartToStart":"EndToEnd",k),b.remove(f))}var h,k,l,m,n,o,p=f.dom.doc,q=p.body;
...
k.select();return}catch(t){}}c(!0);c();h.select()};this.getRangeAt=function(){function d(a){var b=c(g,a),e,f,k=0,o;e=b.node;f=b.offset;if(b.inside&&!e.hasChildNodes())h[a?"setStart":"setEnd"](e,0);else if(void 0===f)h[a?"setStartBefore":"setEndAfter"](e);else{if(0>b.position){b=b.inside?e.firstChild:e.nextSibling;if(!b){h[a?"setStartAfter":"setEndAfter"](e);return}if(!f){if(3==b.nodeType)h[a?"setStart":"setEnd"](b,0);else h[a?"setStartBefore":"setEndBefore"](b);return}for(;b;){o=b.nodeValue;k+=o.length;
if(k>=f){e=b;k-=f;k=o.length-k;break}b=b.nextSibling}}else{b=e.previousSibling;if(!b)return h[a?"setStartBefore":"setEndBefore"](e);if(!f){if(3==e.nodeType)h[a?"setStart":"setEnd"](b,e.nodeValue.length);else h[a?"setStartAfter":"setEndAfter"](b);return}for(;b;){k+=b.nodeValue.length;if(k>=f){e=b;k-=f;break}b=b.previousSibling}}h[a?"setStart":"setEnd"](e,k)}}var g=f.getRng(),h=b.createRng(),k,l,m,n;k=g.item?g.item(0):g.parentElement();if(k.ownerDocument!=b.doc)return h;l=f.isCollapsed();if(g.item)return h.setStart(k.parentNode,
b.nodeIndex(k)),h.setEnd(h.startContainer,h.startOffset+1),h;try{d(!0),l||d()}catch(o){if(-2147024809==o.number)n=a.getBookmark(2),m=g.duplicate(),m.collapse(!0),k=m.parentElement(),l||(m=g.duplicate(),m.collapse(!1),m=m.parentElement(),m.innerHTML=m.innerHTML),k.innerHTML=k.innerHTML,a.moveToBookmark(n),g=f.getRng(),d(!0),l||d();else throw o;}return h}}})();
...
c));return k}var b=m.getRng(!0),d=n.getRoot(),e={};e.start=a(b,!0);m.isCollapsed()||(e.end=a(b));return e}var m=this,n=m.dom,o,p,q,t,s;if(2==a)return m.tridentSel?m.tridentSel.getBookmark(a):l();if(a)return{rng:m.getRng()};o=m.getRng();q=n.uniqueId();t=tinyMCE.activeEditor.selection.isCollapsed();if(o.duplicate||o.item){if(o.item)return s=o.item(0),p=s.nodeName,{name:p,index:d(p,s)};p=o.duplicate();try{o.collapse(),o.pasteHTML('<span data-mce-type="bookmark" id="'+q+'_start" style="overflow:hidden;line-height:0px">\ufeff</span>'),
t||(p.collapse(!1),o.moveToElementText(p.parentElement()),0===o.compareEndPoints("StartToEnd",p)&&p.move("character",-1),p.pasteHTML('<span data-mce-type="bookmark" id="'+q+'_end" style="overflow:hidden;line-height:0px">\ufeff</span>'))}catch(r){return null}}else{s=m.getNode();p=s.nodeName;if("IMG"==p)return{name:p,index:d(p,s)};p=f(o.cloneRange());t||(p.collapse(!1),p.insertNode(n.create("span",{"data-mce-type":"bookmark",id:q+"_end",style:"overflow:hidden;line-height:0px"},"\ufeff")));o=f(o);o.collapse(!0);
...
l.get(c.id+"_"+a),g,h,k;k=c.keep;if(d&&(g=d.parentNode,"start"==a?(k?(g=d.firstChild,h=1):h=l.nodeIndex(d),o=p=g,q=t=h):(k?(g=d.firstChild,h=1):h=l.nodeIndex(d),p=g,t=h),!k)){k=d.previousSibling;g=d.nextSibling;for(b(f.grep(d.childNodes),function(a){if(a.nodeType==3)a.nodeValue=a.nodeValue.replace(/\uFEFF/g,"")});d=l.get(c.id+"_"+a);)l.remove(d,1);k&&g&&k.nodeType==g.nodeType&&3==k.nodeType&&!f.isOpera&&(h=k.nodeValue.length,k.appendData(g.nodeValue),l.remove(g),"start"==a?(o=p=k,q=t=h):(p=k,t=h))}}
function k(b){l.isBlock(b)&&!b.innerHTML&&!a&&(b.innerHTML='<br data-mce-bogus="1" />');return b}var l=this.dom,m,n,o,p,q,t;if(c)if(c.start){m=l.createRng();n=l.getRoot();if(this.tridentSel)return this.tridentSel.moveToBookmark(c);d(!0)&&d()&&this.setRng(m)}else c.id?(h("start"),h("end"),o&&(m=l.createRng(),m.setStart(k(o),q),m.setEnd(k(p),t),this.setRng(m))):c.name?this.select(l.select(c.name)[c.index]):c.rng&&this.setRng(c.rng)},select:function(a,b){function c(a,b){var e=new d(a,a);do{if(3==a.nodeType&&
...
c=a.createRng();c.setStart(b.anchorNode,b.anchorOffset);c.collapse(!0);a=a.createRng();a.setStart(b.focusNode,b.focusOffset);a.collapse(!0);return 0>=c.compareBoundaryPoints(c.START_TO_START,a)},normalize:function(){function a(e){function f(a,b){for(var c=new d(a,s.getParent(a.parentNode,s.isBlock)||r);a=c[b?"prev":"next"]();)if("BR"===a.nodeName)return!0}function o(a,b){var c,e,b=b||p;for(c=new d(b,s.getParent(b.parentNode,s.isBlock)||r);u=c[a?"prev":"next"]();){if(3===u.nodeType&&0<u.nodeValue.length){p=
u;q=a?u.nodeValue.length:0;k=!0;return}if(s.isBlock(u)||D[u.nodeName.toLowerCase()])return;e=u}l&&e&&(p=e,k=!0,q=0)}var p,q,t,s=b.dom,r=s.getRoot(),u,D;p=c[(e?"start":"end")+"Container"];q=c[(e?"start":"end")+"Offset"];D=s.schema.getNonEmptyElements();9===p.nodeType&&(p=s.getRoot(),q=0);if(p===r){if(e&&(u=p.childNodes[0<q?q-1:0]))if(u.nodeName.toLowerCase(),D[u.nodeName]||"TABLE"==u.nodeName)return;if(p.hasChildNodes()&&(p=p.childNodes[Math.min(!e&&0<q?q-1:q,p.childNodes.length-1)],q=0,p.hasChildNodes()&&
!/TABLE/.test(p.nodeName))){u=p;t=new d(p,r);do{if(3===u.nodeType&&0<u.nodeValue.length){q=e?0:u.nodeValue.length;p=u;k=!0;break}if(D[u.nodeName.toLowerCase()]){q=s.nodeIndex(u);p=u.parentNode;"IMG"==u.nodeName&&!e&&q++;k=!0;break}}while(u=e?t.next():t.prev())}}l&&(3===p.nodeType&&0===q&&o(!0),1===p.nodeType&&(u=p.childNodes[q])&&"BR"===u.nodeName&&!f(u)&&!f(u,!0)&&o(!0,p.childNodes[q]));e&&!l&&3===p.nodeType&&q===p.nodeValue.length&&o(!1);if(k)c["set"+(e?"Start":"End")](p,q)}var b=this,c,k,l;f.isIE||
...
(function(f){f.dom.RangeUtils=function(c){this.walk=function(a,b){function d(a){var b;b=a[0];3===b.nodeType&&b===k&&l>=b.nodeValue.length&&a.splice(0,1);b=a[a.length-1];0===n&&0<a.length&&b===m&&3===b.nodeType&&a.splice(a.length-1,1);return a}function e(a,b,c){for(var d=[];a&&a!=c;a=a[b])d.push(a);return d}function g(a,b){do{if(a.parentNode==b)return a;a=a.parentNode}while(a)}function h(a,c,g){var h=g?"nextSibling":"previousSibling";q=a;for(t=q.parentNode;q&&q!=c;q=t)t=q.parentNode,s=e(q==a?q:q[h],
h),s.length&&(g||s.reverse(),b(d(s)))}var k=a.startContainer,l=a.startOffset,m=a.endContainer,n=a.endOffset,o,p,q,t,s;p=c.select("td.mceSelected,th.mceSelected");if(0<p.length)f.each(p,function(a){b([a])});else{1==k.nodeType&&k.hasChildNodes()&&(k=k.childNodes[l]);1==m.nodeType&&m.hasChildNodes()&&(m=m.childNodes[Math.min(n-1,m.childNodes.length-1)]);if(k==m)return b(d([k]));o=c.findCommonAncestor(k,m);for(q=k;q;q=q.parentNode){if(q===m)return h(k,o,!0);if(q===o)break}for(q=m;q;q=q.parentNode){if(q===
k)return h(m,o);if(q===o)break}p=g(k,o)||k;o=g(m,o)||m;h(k,p,!0);s=e(p==k?p:p.nextSibling,"nextSibling",o==m?o.nextSibling:o);s.length&&b(d(s));h(m,o)}};this.split=function(a){var b=a.startContainer,c=a.startOffset,e=a.endContainer,a=a.endOffset;if(b==e&&3==b.nodeType)0<c&&c<b.nodeValue.length&&(e=b.splitText(c),b=e.previousSibling,a>c?(b=e=e.splitText(a-c).previousSibling,a=e.nodeValue.length,c=0):a=0);else if(3==b.nodeType&&0<c&&c<b.nodeValue.length&&(b=b.splitText(c),c=0),3==e.nodeType&&0<a&&a<
...
(function(f){var c=f.dom.Event,a=f.each;f.create("tinymce.ui.KeyboardNavigation",{KeyboardNavigation:function(b,d){var e=this,g=b.root,h=b.items,k=b.enableUpDown,l=b.enableLeftRight||!b.enableUpDown,m=b.excludeFromTabOrder,n,o,p,q,t,d=d||f.DOM;n=function(a){t=a.target.id};o=function(a){d.setAttrib(a.target.id,"tabindex","-1")};q=function(){var a=d.get(t);d.setAttrib(a,"tabindex","0");a.focus()};e.focus=function(){d.get(t).focus()};e.destroy=function(){a(h,function(a){a=d.get(a.id);d.unbind(a,"focus",
n);d.unbind(a,"blur",o)});var b=d.get(g);d.unbind(b,"focus",q);d.unbind(b,"keydown",p);h=d=g=e.focus=n=o=p=q=null;e.destroy=function(){}};e.moveFocus=function(e,g){var f=-1,k;if(t){a(h,function(a,b){if(a.id===t)return f=b,!1});f+=e;0>f?f=h.length-1:f>=h.length&&(f=0);k=h[f];d.setAttrib(t,"tabindex","-1");d.setAttrib(k.id,"tabindex","0");d.get(k.id).focus();if(b.actOnFocus)b.onAction(k.id);g&&c.cancel(g)}};p=function(a){switch(a.keyCode){case 37:l&&e.moveFocus(-1);break;case 39:l&&e.moveFocus(1);break;
case 38:k&&e.moveFocus(-1);break;case 40:k&&e.moveFocus(1);break;case 27:b.onCancel&&(b.onCancel(),c.cancel(a));break;case 14:case 13:case 32:b.onAction&&(b.onAction(t),c.cancel(a))}};a(h,function(a,b){var c,e;a.id||(a.id=d.uniqueId("_mce_item_"));e=d.get(a.id);m?(d.bind(e,"blur",o),c="-1"):c=0===b?"0":"-1";e.setAttribute("tabindex",c);d.bind(e,"focus",n)});h[0]&&(t=h[0].id);d.setAttrib(g,"tabindex","-1");var s=d.get(g);d.bind(s,"focus",q);d.bind(s,"keydown",p)}})})(tinymce);
...
c){/^(FontName|FontSize)$/.test(c)||b.nodeChanged()});b.onBeforeRenderUI.dispatch(b,b.controlManager);e.render_ui&&b.theme&&(b.orgDisplay=r.style.display,"function"!=typeof e.theme?(h=e.width||r.style.width||r.offsetWidth,t=e.height||r.style.height||r.offsetHeight,s=e.min_height||100,x=/^[0-9\.]+(|px)$/i,x.test(""+h)&&(h=Math.max(parseInt(h,10)+(u.deltaWidth||0),100)),x.test(""+t)&&(t=Math.max(parseInt(t,10)+(u.deltaHeight||0),s)),u=b.theme.renderUI({targetNode:r,width:h,height:t,deltaWidth:e.delta_width,
deltaHeight:e.delta_height}),c.setStyles(u.sizeContainer||u.editorContainer,{width:h,height:t}),t=(u.iframeHeight||t)+("number"==typeof t?u.deltaHeight||0:""),t<s&&(t=s)):(u=e.theme(b,r),u.editorContainer.nodeType&&(u.editorContainer=u.editorContainer.id=u.editorContainer.id||b.id+"_parent"),u.iframeContainer.nodeType&&(u.iframeContainer=u.iframeContainer.id=u.iframeContainer.id||b.id+"_iframecontainer"),t=u.iframeHeight||r.offsetHeight,g&&b.onInit.add(function(a){a.dom.bind(a.getBody(),"beforedeactivate keydown",
function(){a.lastIERng=a.selection.getRng()})})),b.editorContainer=u.editorContainer);e.content_css&&d(m(e.content_css),function(a){b.contentCSS.push(b.documentBaseURI.toAbsolute(a))});if(e.content_editable)return r=u=null,b.initContentBody();document.domain&&location.hostname!=document.domain&&(f.relaxedDomain=document.domain);b.iframeHTML=e.doctype+'<html><head xmlns="/web/20130128163946/http://www.w3.org/1999/xhtml">';e.document_base_url!=f.documentBaseURL&&(b.iframeHTML+='<base href="'+b.documentBaseURI.getURI()+
...
tinymce.ForceBlocks=function(f){function c(){var c=d.getStart(),h=f.getBody(),k,l,m,n,o,p,q,t,s;if(c&&1===c.nodeType&&a.forced_root_block){for(;c&&c!=h;){if(e[c.nodeName])return;c=c.parentNode}k=d.getRng();if(k.setStart)l=k.startContainer,m=k.startOffset,n=k.endContainer,o=k.endOffset;else if(k.item&&(c=k.item(0),k=f.getDoc().body.createTextRange(),k.moveToElementText(c)),s=k.parentElement().ownerDocument===f.getDoc(),tmpRng=k.duplicate(),tmpRng.collapse(!0),m=-1*tmpRng.move("character",-16777215),
!tmpRng.collapsed)tmpRng=k.duplicate(),tmpRng.collapse(!1),o=-1*tmpRng.move("character",-16777215)-m;for(c=h.firstChild;c;)3===c.nodeType||1==c.nodeType&&!e[c.nodeName]?(p||(p=b.create(a.forced_root_block),c.parentNode.insertBefore(p,c),t=!0),q=c,c=c.nextSibling,p.appendChild(q)):(p=null,c=c.nextSibling);if(t){if(k.setStart)k.setStart(l,m),k.setEnd(n,o),d.setRng(k);else if(s)try{k=f.getDoc().body.createTextRange(),k.moveToElementText(h),k.collapse(!0),k.moveStart("character",m),0<o&&k.moveEnd("character",
...
3==b.nodeType?b.length:b.childNodes.length)}return a}function t(a,b,c,d,e){var g=[],h=-1,k,l=-1,o=-1,m;C(a.childNodes,function(a,b){if("UL"===a.nodeName||"OL"===a.nodeName)return h=b,k=a,!1});C(a.childNodes,function(a,c){"SPAN"===a.nodeName&&"bookmark"==y.getAttrib(a,"data-mce-type")&&(a.id==b.id+"_start"?l=c:a.id==b.id+"_end"&&(o=c))});if(0>=h||l<h&&o>h)return C(f.grep(a.childNodes),e),0;m=y.clone(c,J);C(f.grep(a.childNodes),function(a,b){if(l<h&&b<h||l>h&&b>h)g.push(a),a.parentNode.removeChild(a)});
l<h?a.insertBefore(m,k):l>h&&a.insertBefore(m,k.nextSibling);d.push(m);C(g,function(a){m.appendChild(a)});return m}function u(c,d,g){var h=[],o,p,s=!0;o=E.inline||E.block;p=y.create(o);l(p);L.walk(c,function(c){function m(c){var q,u,x,A,D;D=s;q=c.nodeName.toLowerCase();u=c.parentNode.nodeName.toLowerCase();1===c.nodeType&&S(c)&&(D=s,s="true"===S(c),A=!0);if(n(q,"br"))r=0,E.block&&y.remove(c);else if(E.wrapper&&k(c,a,e))r=0;else if(s&&!A&&E.block&&!E.wrapper&&/^(h[1-6]|p|div|pre|address|dl|dt|dd)$/.test(q))c=
y.rename(c,o),l(c),h.push(c),r=0;else{if(E.selector&&(C(v,function(a){if(!("collapsed"in a&&a.collapsed!==W)&&y.is(c,a.selector)&&!b(c)){l(c,a);x=true}}),!E.inline||x)){r=0;return}s&&!A&&O(o,q)&&O(u,o)&&(g||!(3===c.nodeType&&1===c.nodeValue.length&&65279===c.nodeValue.charCodeAt(0)))&&!b(c)?(r||(r=y.clone(p,J),c.parentNode.insertBefore(r,c),h.push(r)),r.appendChild(c)):"li"==q&&d?r=t(c,d,p,h,m):(r=0,C(f.grep(c.childNodes),m),A&&(s=D),r=0)}}var r;C(c,m)});!1===E.wrap_links&&C(h,function(a){function b(a){var c,
...
Q.setEndAfter(h),u(s(Q,v),null,!0)):u(h,null,!0);else if(!W||!E.inline||y.select("td.mceSelected,th.mceSelected").length){var K=c.selection.getNode();!M&&v[0].defaultBlock&&!y.getParent(K,y.isBlock)&&g(v[0].defaultBlock);c.selection.setRng(o());Q=F.getBookmark();u(s(F.getRng(I),v),Q);if(E.styles&&(E.styles.color||E.styles.textDecoration))f.walk(K,V,"childNodes"),V(K);F.moveToBookmark(Q);B(F.getRng(I));c.nodeChanged()}else z("apply",a,e)}function h(b,e,g){function h(a){var b,c,d,g,k;1===a.nodeType&&
...
k||(k=f),h=f)}if(d&&(!u.mixed||!H(a)))b=y.split(a,b);h&&(c.parentNode.insertBefore(h,c),k.appendChild(c))}return b}function p(a){var b=y.get(a?"_start":"_end"),c=b[a?"firstChild":"lastChild"];x(c)&&(c=c[a?"firstChild":"lastChild"]);y.remove(b,!0);return c}function n(a){var b,d,a=s(a,q,I);u.split&&(b=v(a,I),d=v(a),b!=d?(/^(TR|TD)$/.test(b.nodeName)&&b.firstChild&&(b=("TD"==b.nodeName?b.firstChild:b.firstChild.firstChild)||b),b=t(b,"span",{id:"_start","data-mce-type":"bookmark"}),d=t(d,"span",{id:"_end",
...
b,H));e&&d[0].wrapper&&(e=a(e,"ul,ol").reverse()[0]||e);if(!e)for(e=b;e[c]&&!H(e[c])&&!(e=e[c],n(e,"br")););return e||b}var m,p=b.startContainer,r=b.startOffset,s=b.endContainer,u=b.endOffset;1==p.nodeType&&p.hasChildNodes()&&(m=p.childNodes.length-1,p=p.childNodes[r>m?m:r],3==p.nodeType&&(r=0));1==s.nodeType&&s.hasChildNodes()&&(m=s.childNodes.length-1,s=s.childNodes[u>m?m:u-1],3==s.nodeType&&(u=s.nodeValue.length));p=h(p);s=h(s);if(x(p.parentNode)||x(p))p=x(p)?p:p.parentNode,p=p.nextSibling||p,
3==p.nodeType&&(r=0);if(x(s.parentNode)||x(s))s=x(s)?s:s.parentNode,s=s.previousSibling||s,3==s.nodeType&&(u=s.length);if(d[0].inline){if(b.collapsed){if(m=k(p,r,!0))p=m.container,r=m.offset;if(m=k(s,u))s=m.container,u=m.offset}m=f(s,u);if(m.node){for(;m.node&&0===m.offset&&m.node.previousSibling;)m=f(m.node.previousSibling);m.node&&0<m.offset&&3===m.node.nodeType&&" "===m.node.nodeValue.charAt(m.offset-1)&&1<m.offset&&(s=m.node,s.splitText(m.offset-1))}}if(d[0].inline||d[0].block_expand){if(!d[0].inline||
3!=p.nodeType||0===r)p=g(!0);if(!d[0].inline||3!=s.nodeType||u===s.nodeValue.length)s=g()}d[0].selector&&d[0].expand!==J&&!d[0].inline&&(p=l(p,"previousSibling"),s=l(s,"nextSibling"));if(d[0].block||d[0].selector)p=o(p,"previousSibling"),s=o(s,"nextSibling"),d[0].block&&(H(p)||(p=g(!0)),H(s)||(s=g()));1==p.nodeType&&(r=K(p),p=p.parentNode);1==s.nodeType&&(u=K(s)+1,s=s.parentNode);return{startContainer:p,startOffset:r,endContainer:s,endOffset:u}}function r(a,b,c,d){var e,g,f;if(!m(c,a))return J;if("all"!=
...
c.getBody())).prev()||d);return d}function z(a,b,e){function l(a){var b=y.create("span",{id:t,"data-mce-bogus":!0,style:x?"color:red":""});a&&b.appendChild(c.getDoc().createTextNode(N));return b}function o(a,b){for(;a;){if(3===a.nodeType&&a.nodeValue!==N||1<a.childNodes.length)return!1;b&&1===a.nodeType&&b.push(a);a=a.firstChild}return!0}function m(a){for(;a;){if(a.id===t)return a;a=a.parentNode}}function p(a){var b;if(a){b=new G(a,a);for(a=b.current();a;a=b.next())if(3===a.nodeType)return a}}function r(a,
b){var c,d;if(a)d=F.getRng(!0),o(a)?(!1!==b&&(d.setStartBefore(a),d.setEndBefore(a)),y.remove(a)):(c=p(a),c.nodeValue.charAt(0)===N&&c.deleteData(0,1),y.remove(a,1)),F.setRng(d);else if(a=m(F.getStart()),!a)for(;a=y.get(t);)r(a,!1)}function n(){var a,c,f,h,k;a=F.getRng(!0);h=a.startOffset;k=a.startContainer.nodeValue;(c=m(F.getStart()))&&(f=p(c));if(k&&0<h&&h<k.length&&/\w/.test(k.charAt(h))&&/\w/.test(k.charAt(h-1)))c=F.getBookmark(),a.collapse(!0),a=s(a,d(b)),a=L.split(a),g(b,e,a),F.moveToBookmark(c);
else{if(!c||f.nodeValue!==N)c=l(!0),f=c.firstChild,a.insertNode(c),h=1;g(b,e,c);F.setCursorLocation(f,h)}}function q(){var a=F.getRng(!0),c,g,f,o,m,p=[];c=a.startContainer;g=a.startOffset;f=c;if(3==c.nodeType){if(g!=c.nodeValue.length||c.nodeValue===N)o=!0;f=f.parentNode}for(;f;){if(k(f,b,e)){m=f;break}f.nextSibling&&(o=!0);p.push(f);f=f.parentNode}if(m)if(o)f=F.getBookmark(),a.collapse(!0),a=s(a,d(b),!0),a=L.split(a),h(b,e,a),F.moveToBookmark(f);else{f=c=l();for(a=p.length-1;0<=a;a--)f.appendChild(y.clone(p[a],
!1)),f=f.firstChild;f.appendChild(y.doc.createTextNode(N));f=f.firstChild;y.insertAfter(c,m);F.setCursorLocation(f,1)}}function u(){var a;(a=m(F.getStart()))&&!y.isEmpty(a)&&f.walk(a,function(a){1==a.nodeType&&a.id!==t&&!y.isEmpty(a)&&y.setAttrib(a,"data-mce-bogus",null)},"childNodes")}var t="_mce_caret",x=c.settings.caret_debug;self._hasCaretEvents||(c.onBeforeGetContent.addToTop(function(){var a=[],b;if(o(m(F.getStart()),a))for(b=a.length;b--;)y.setAttrib(a[b],"data-mce-bogus","1")}),f.each(["onMouseUp",
"onKeyUp"],function(a){c[a].addToTop(function(){r();u()})}),c.onKeyDown.addToTop(function(a,b){var c=b.keyCode;(8==c||37==c||39==c)&&r(m(F.getStart()));u()}),F.onSetContent.add(u),self._hasCaretEvents=!0);"apply"==a?n():q()}function B(a){var b=a.startContainer,c=a.startOffset,d,e;3==b.nodeType&&c>=b.nodeValue.length&&(c=K(b),b=b.parentNode,d=!0);if(1==b.nodeType){e=b.childNodes;b=e[Math.min(c,e.length-1)];b=new G(b,y.getParent(b,y.isBlock));(c>e.length-1||d)&&b.next();for(c=b.current();c;c=b.next())if(3==
...
b)}}return a}function q(){function a(b){for(var c=C[b?"firstChild":"lastChild"];c&&1!=c.nodeType;)c=c[b?"nextSibling":"previousSibling"];return c===v}B=G?n(G):d.create("BR");a(!0)&&a()?d.replace(B,C):a(!0)?C.parentNode.insertBefore(B,C):(a()||(u=r.cloneRange(),u.setStartAfter(v),u.setEndAfter(C),E=u.extractContents(),d.insertAfter(E,C)),d.insertAfter(B,C));d.remove(v);m(B);h.add()}function t(){var a,b,g;if(g=x&&3==x.nodeType&&A>=x.nodeValue.length)if(g=!f.isIE){a:{g=new c(x,v);for(var k;k=g.current();){if("BR"==
k.nodeName){a=!0;break a}g.next()}}g=!a}g&&(a=d.create("br"),r.insertNode(a),r.setStartAfter(a),r.setEndAfter(a),b=!0);a=d.create("br");r.insertNode(a);f.isIE&&"PRE"==y&&(!z||8>z)&&a.parentNode.insertBefore(d.doc.createTextNode("\r"),a);b?(r.setStartBefore(a),r.setEndBefore(a)):(r.setStartAfter(a),r.setEndAfter(a));e.setRng(r);h.add()}function s(a){do 3===a.nodeType&&(a.nodeValue=a.nodeValue.replace(/^[\r\n]+/,"")),a=a.firstChild;while(a)}var r=e.getRng(!0),u,D,x,A,v,z,B,E,C,y,F,G,L;if(r.collapsed){if(!b.isDefaultPrevented()&&
(x=r.startContainer,A=r.startOffset,G=(G=g.forced_root_block)?G.toUpperCase():"",z=d.doc.documentMode,1==x.nodeType&&x.hasChildNodes()&&(L=A>x.childNodes.length-1,x=x.childNodes[Math.min(A,x.childNodes.length-1)]||x,A=0),D=function(a){for(var b=d.getRoot(),c;a!==b&&d.getContentEditable(a)!=="false";){d.getContentEditable(a)==="true"&&(c=a);a=a.parentNode}return a!==b?c:b}(x)))if(h.beforeChange(),!d.isBlock(D)&&D!=d.getRoot())(!G||b.shiftKey)&&t();else{if(G&&!b.shiftKey||!G&&b.shiftKey)x=p(x,A);C=
(v=d.getParent(x,d.isBlock))?d.getParent(v.parentNode,d.isBlock):null;y=v?v.nodeName.toUpperCase():"";F=C?C.nodeName.toUpperCase():"";if("LI"==y&&d.isEmpty(v)){if(/^(UL|OL|LI)$/.test(C.parentNode.nodeName))return!1;q()}else{if("PRE"==y&&!1!==g.br_in_pre){if(!b.shiftKey){t();return}}else if(!G&&!b.shiftKey&&"LI"!=y||G&&b.shiftKey){t();return}G=G||"P";o()?(B=/^(H[1-6]|PRE)$/.test(y)&&"HGROUP"!=F?n(G):n(),g.end_container_on_empty_block&&l(C)&&d.isEmpty(v)?B=d.split(C,v):d.insertAfter(B,v)):o(!0)?B=v.parentNode.insertBefore(n(),
v):(u=r.cloneRange(),u.setEndAfter(v),E=u.extractContents(),s(E),B=E.firstChild,d.insertAfter(E,v));d.setAttrib(B,"id","");m(B);h.add()}}}else a.execCommand("Delete")}var d=a.dom,e=a.selection,g=a.settings,h=a.undoManager;a.onKeyDown.add(function(a,c){13==c.keyCode&&!1!==b(c)&&c.preventDefault()})}})(tinymce);
...
b){return g(b)}));a.onInit.add(function(){a.controlManager.setActive("pastetext",a.pasteAsPlainText);f(a,"paste_block_drop")&&a.dom.bind(a.getBody(),"dragend,dragover,draggesture,dragdrop,drop,drag".split(","),function(a){a.preventDefault();a.stopPropagation();return false})});h._legacySupport()},getInfo:function(){return{longname:"Paste text/word",author:"Moxiecode Systems AB",authorurl:"/web/20130128163946/http://tinymce.moxiecode.com",infourl:"/web/20130128163946/http://wiki.moxiecode.com/index.php/TinyMCE:Plugins/paste",version:tinymce.majorVersion+
...
c="{"+c+"}"}return c}return""+a}function e(a){var b=!1,c=null,d,e,g,f,h,s=0;try{try{c=new ActiveXObject("AgControl.AgControl"),c.IsVersionSupported(a)&&(b=!0)}catch(r){var u=navigator.plugins["Silverlight Plug-In"];if(u){d=u.description;"1.0.30226.2"===d&&(d="2.0.30226.2");for(e=d.split(".");3<e.length;)e.pop();for(;4>e.length;)e.push(0);for(g=a.split(".");4<g.length;)g.pop();do f=parseInt(g[s],10),h=parseInt(e[s],10),s++;while(s<g.length&&f===h);f<=h&&!isNaN(f)&&(b=!0)}}}catch(D){b=!1}return b}var g=
{},h={};a.silverlight={trigger:function(b,c){var d=g[b],e;d&&(e=a.toArray(arguments).slice(1),e[0]="Silverlight:"+c,setTimeout(function(){d.trigger.apply(d,e)},0))}};a.runtimes.Silverlight=a.addRuntime("silverlight",{getFeatures:function(){return{jpgresize:!0,pngresize:!0,chunks:!0,progress:!0,multipart:!0,multi_selection:!0}},init:function(b,l){function m(){return c.getElementById(b.id+"_silverlight").content.Upload}var n,o="",p=b.settings.filters,q,t=c.body;if(!e("2.0.31005.0")||f.opera&&f.opera.buildNumber)l({success:!1});
else{h[b.id]=!1;g[b.id]=b;n=c.createElement("div");n.id=b.id+"_silverlight_container";a.extend(n.style,{position:"absolute",top:"0px",background:b.settings.shim_bgcolor||"transparent",zIndex:99999,width:"100px",height:"100px",overflow:"hidden",opacity:b.settings.shim_bgcolor||8<c.documentMode?"":0.01});n.className="plupload silverlight";b.settings.container&&(t=c.getElementById(b.settings.container),"static"===a.getStyle(t,"position")&&(t.style.position="relative"));t.appendChild(n);for(q=0;q<p.length;q++)o+=
...
d=d.settings.browse_button_active;e&&d&&a.removeClass(e,d)});b.bind("DisableBrowse",function(a,b){m().DisableBrowse(b)});b.bind("Destroy",function(b){a.removeAllEvents(c.body,b.id);delete h[b.id];delete g[b.id];(b=c.getElementById(b.id+"_silverlight_container"))&&t.removeChild(b)});l({success:true})}})}}})})(window,document,plupload);
...
progress:!0,multipart:!0,multi_selection:!0}},init:function(g,f){function k(){return c.getElementById(g.id+"_flash")}function l(){5E3<n++?f({success:!1}):!1===e[g.id]&&setTimeout(l,1)}var m,n=0,o=c.body;10>b()?f({success:!1}):(e[g.id]=!1,d[g.id]=g,c.getElementById(g.settings.browse_button),m=c.createElement("div"),m.id=g.id+"_flash_container",a.extend(m.style,{position:"absolute",top:"0px",background:g.settings.shim_bgcolor||"transparent",zIndex:99999,width:"100%",height:"100%"}),m.className="plupload flash",
...
f.style.position="absolute";k=c.createElement("input");k.setAttribute("id","input_"+p);k.setAttribute("type","file");k.setAttribute("accept",s);k.setAttribute("size",1);n=b(e.settings.browse_button);e.features.triggerDialog&&n&&a.addEvent(b(e.settings.browse_button),"click",function(a){k.disabled||k.click();a.preventDefault()},e.id);a.extend(k.style,{width:"100%",height:"100%",opacity:0,fontSize:"99px",cursor:"pointer"});a.extend(f.style,{overflow:"hidden"});if(m=e.settings.shim_bgcolor)f.style.background=
m;t&&a.extend(k.style,{filter:"alpha(opacity=0)"});a.addEvent(k,"change",function(c){var l=c.target,c=[];l.value&&(b("form_"+p).style.top="-1048575px",l=l.value.replace(/\\/g,"/"),l=l.substring(l.length,l.lastIndexOf("/")+1),c.push(new a.File(p,l)),e.features.triggerDialog?a.removeEvent(n,"click",e.id):a.removeAllEvents(f,e.id),a.removeEvent(k,"change",e.id),h(),c.length&&d.trigger("FilesAdded",c))},e.id);f.appendChild(k);l.appendChild(f);e.refresh()}function k(){var b=c.createElement("div");b.innerHTML=
'<iframe id="'+e.id+'_iframe" name="'+e.id+'_iframe" src="'+n+':&quot;&quot;" style="display:none"></iframe>';m=b.firstChild;l.appendChild(m);a.addEvent(m,"load",function(b){var b=b.target,c;if(o){try{c=b.contentWindow.document||b.contentDocument||f.frames[b.id].document}catch(d){e.trigger("Error",{code:a.SECURITY_ERROR,message:a.translate("Security error."),file:o});return}c=c.body.innerHTML;c.match(/success/)?(o.status=a.DONE,o.loaded=1025,o.percent=100,e.trigger("UploadProgress",o),e.trigger("FileUploaded",
o,{response:c})):e.trigger("Error",{code:a.GENERIC_ERROR,message:c,file:o})}},e.id)}var l=c.body,m,n="javascript",o,p,q=[],t=/MSIE/.test(navigator.userAgent),s=[],r=e.settings.filters,u,D,x,A;u=0;a:for(;u<r.length;u++){D=r[u].extensions.split(/,/);for(A=0;A<D.length;A++){if("*"===D[A]){s=[];break a}(x=a.mimeTypes[D[A]])&&-1===a.inArray(x,s)&&s.push(x)}}s=s.join(",");e.settings.container&&(l=b(e.settings.container),"static"===a.getStyle(l,"position")&&(l.style.position="relative"));e.bind("UploadFile",
function(d,e){var g;if(!(e.status==a.DONE||e.status==a.FAILED||d.state==a.STOPPED)){g=b("form_"+e.id);b("input_"+e.id).setAttribute("name",d.settings.file_data_name);g.setAttribute("action",d.settings.url);a.each(a.extend({name:e.target_name||e.name},d.settings.multipart_params),function(b,d){var e=c.createElement("input");a.extend(e,{type:"hidden",name:d,value:b});g.insertBefore(e,g.firstChild)});o=e;b("form_"+p).style.top="-1048575px";g.submit()}});e.bind("FileUploaded",function(a){a.refresh()});
e.bind("StateChanged",function(c){c.state==a.STARTED?k():c.state==a.STOPPED&&f.setTimeout(function(){a.removeEvent(m,"load",c.id);m.parentNode&&m.parentNode.removeChild(m)},0);a.each(c.files,function(c){if(c.status===a.DONE||c.status===a.FAILED)(c=b("form_"+c.id))&&c.parentNode.removeChild(c)})});e.bind("Refresh",function(d){var e,g,f,h,k,l;if(e=b(d.settings.browse_button)){k=a.getPos(e,b(d.settings.container));l=a.getSize(e);g=b("form_"+p);b("input_"+p);a.extend(g.style,{top:k.y+"px",left:k.x+"px",
width:l.w+"px",height:l.h+"px"});if(d.features.triggerDialog){a.getStyle(e,"position")==="static"&&a.extend(e.style,{position:"relative"});k=parseInt(e.style.zIndex,10);isNaN(k)&&(k=0);a.extend(e.style,{zIndex:k});a.extend(g.style,{zIndex:k-1})}f=d.settings.browse_button_hover;h=d.settings.browse_button_active;g=d.features.triggerDialog?e:g;if(f){a.addEvent(g,"mouseover",function(){a.addClass(e,f)},d.id);a.addEvent(g,"mouseout",function(){a.removeClass(e,f)},d.id)}if(h){a.addEvent(g,"mousedown",function(){a.addClass(e,
h)},d.id);a.addEvent(c.body,"mouseup",function(){a.removeClass(e,h)},d.id)}}});d.bind("FilesRemoved",function(a,c){var d,e;for(d=0;d<c.length;d++)(e=b("form_"+c[d].id))&&e.parentNode.removeChild(e)});d.bind("DisableBrowse",function(a,b){var d=c.getElementById("input_"+p);if(d)d.disabled=b});d.bind("Destroy",function(d){var e,g,f,h={inputContainer:"form_"+p,inputFile:"input_"+p,browseButton:d.settings.browse_button};for(e in h)(g=b(h[e]))&&a.removeAllEvents(g,d.id);a.removeAllEvents(c.body,d.id);a.each(q,
function(a){(f=b("form_"+a))&&l.removeChild(f)})});h()});e({success:!0})}})})(window,document,plupload);
...
(function(f){var c=f.util.Dispatcher;f.UndoManager=function(a){function b(){return f.trim(a.getContent({format:"raw",no_events:1}).replace(/<span[^>]+data-mce-bogus[^>]+>[\u200B\uFEFF]+<\/span>/g,"")).replace(/(?:&nbsp;)+$/g,"")}var d;d={typing:!1,onAdd:new c(d),onUndo:new c(d),onRedo:new c(d),undoData:[],currentLevel:null,redoData:[],nestLevel:0,getLevels:function(){var a=[],b=[];jQuery.each(this.undoData,function(){a.push(this.content)});jQuery.each(this.redoData,function(){b.push(this.content)});
return[a,this.currentLevel.content,b]},begin:function(){this.add();++this.nestLevel},end:function(){--this.nestLevel;this.add()},add:function(b){return f.mainEditor.plugins.wsundomain.add(a,b)},remove:function(){return f.mainEditor.plugins.wsundomain.remove(a)},undo:function(){return f.mainEditor.plugins.wsundomain.undo()},redo:function(){return f.mainEditor.plugins.wsundomain.redo()},clear:function(){return f.mainEditor.plugins.wsundomain.clear()},hasUndo:function(){return f.mainEditor.plugins.wsundomain.hasUndo()},
hasRedo:function(){return f.mainEditor.plugins.wsundomain.hasRedo()},updateButtonState:function(){return f.mainEditor.plugins.wsundomain.updateButtonState()},subAdd:function(c){if(0<this.nestLevel)return null;d.typing=!1;var g=a.settings,c=c||{};c.content=b();if(d.currentLevel&&d.currentLevel.content==c.content)return null;g.custom_undo_redo_levels&&d.redoData.length+d.undoData.length>g.custom_undo_redo_levels+1&&d.dropOldestUndo();c.bookmark=a.selection.getBookmark(2,!0);d.clearRedo();d.undoData.push(d.currentLevel);
d.currentLevel=c;d.onAdd.dispatch(d,c);a.isNotDirty=0;return c},subRemove:function(){return 0<this.nestLevel?null:d.undoData.pop()},beforeChange:function(){d.currentLevel&&(d.currentLevel.beforeBookmark=a.selection.getBookmark(2,!0))},clearRedo:function(){d.redoData=[]},dropOldestUndo:function(){return d.undoData.shift()},subUndo:function(){d.typing&&d.add();if(!d.subHasUndo())return null;d.redoData.push(d.currentLevel);d.currentLevel=d.undoData.pop();a.setContent(d.currentLevel.content,{format:"raw",
no_events:!0});a.selection.moveToBookmark(d.currentLevel.beforeBookmark);d.onUndo.dispatch(d,d.currentLevel);return d.currentLevel},subRedo:function(){if(!d.subHasRedo())return null;d.undoData.push(d.currentLevel);d.currentLevel=d.redoData.pop();a.setContent(d.currentLevel.content,{format:"raw",no_events:!0});a.selection.moveToBookmark(d.currentLevel.bookmark);d.onRedo.dispatch(d,d.currentLevel);return d.currentLevel},subClear:function(){d.undoData=[];d.currentLevel={content:b(),bookmark:a.selection.getBookmark(2,
!0)};d.redoData=[];d.typing=!1},subHasUndo:function(){return 0<d.undoData.length||d.typing},subHasRedo:function(){return 0<d.redoData.length}};d.onAdd.add(function(b,c){return a.onChange.dispatch(a,c,b)});d.onUndo.add(function(b,c){a.onUndo.dispatch(a,c,b);return a.onChange.dispatch(a,c,b)});d.onRedo.add(function(b,c){a.onRedo.dispatch(a,c,b);return a.onChange.dispatch(a,c,b)});a.onBeforeExecCommand.add(function(a,b,c,f,l){"Undo"!=b&&"Redo"!=b&&"mceRepaint"!=b&&(!l||!l.skip_undo)&&d.beforeChange()});
a.onExecCommand.add(function(a,b,c,f,l){"Undo"!=b&&"Redo"!=b&&"mceRepaint"!=b&&(!l||!l.skip_undo)&&d.add()});a.onSaveContent.add(function(){d.add()});a.dom.bind(a.dom.getRoot(),"dragend",function(){d.add()});a.dom.bind(a.getDoc(),f.isGecko?"blur":"focusout",function(){!a.removed&&d.typing&&d.add()});a.onKeyUp.add(function(a,b){var c=b.keyCode;(33<=c&&36>=c||37<=c&&40>=c||45==c||13==c||b.ctrlKey)&&d.add()});a.onKeyDown.add(function(a,b){var c=b.keyCode;if(33<=c&&36>=c||37<=c&&40>=c||45==c)d.typing&&
d.add();else if((16>c||20<c)&&224!=c&&91!=c&&!d.typing)d.beforeChange(),d.add(),d.typing=!0});a.onMouseDown.add(function(){d.typing&&d.add()});a.addShortcut("ctrl+z","undo_desc","Undo");a.addShortcut("ctrl+y","redo_desc","Redo");return d};f.create("wikispaces.plugins.UndoPlugin",{init:function(a){a.onNodeChange.add(function(a){a.undoManager.updateButtonState()});a.onDeactivate.add(function(a){a.initialized&&a.undoManager.typing&&a.undoManager.add()});a.onInit.add(function(a){a.undoManager.subClear();
f.mainEditor.plugins.wsundomain.removeEditor(a)});a.onKeyDown.add(function(a,c){16==c.keyCode||17==c.keyCode||18==c.keyCode||a.undoManager.updateButtonState()})}});f.PluginManager.add("wsundo",wikispaces.plugins.UndoPlugin)})(tinymce);
...
"class":"btn",onclick:function(){ws.common.track("Editor","Stop","Cancel");d.timeTracker._recordEndTime();try{_gaq.push(function(){d.timeTracker._track(_gat._getTrackerByName(),void 0,"Editor")})}catch(a){}d.isContentDirty()&&d.editor.plugins.wsautosave.autosave(!1);d.noDirtyCheck=!0;document.location=d.editor.getParam("wssave_cancel_url")}}));return e},getInfo:function(){return{longname:"Wikispaces save",author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",infourl:"/web/20130128163946/http://wikispaces.com",version:"0.1"}},
...
(a.prepend(a.prev().html()),a.prev().remove())},getInfo:function(){return{longname:"Wikispaces list",author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",infourl:"/web/20130128163946/http://wikispaces.com",version:"0.1"}}});f.PluginManager.add("wslist",wikispaces.plugins.ListPlugin)})(tinymce,jQuery);
...
getInfo:function(){return{longname:"Wikispaces toolbar scroll",author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",infourl:"/web/20130128163946/http://wikispaces.com",version:"0.1"}}});f.PluginManager.add("wstoolbarscroll",wikispaces.plugins.ToolbarScrollPlugin)})(tinymce,jQuery);
...
k.initial||("A"==c.nodeName&&!c.name&&-1==c.href.indexOf("#mce_temp_url#")&&"visual"==a.plugins.wscommon.getOption("mode")?f.mainEditor.plugins.wslinkoverlay.show(c):f.mainEditor.plugins.wslinkoverlay.hide())});a.onDblClick.add(function(a,b){"A"==b.target.nodeName&&("A"==b.target.nodeName&&a.selection.select(b.target),a.execCommand("wslink"))});a.plugins.wscommon.disableUntilLibsLoad(a,"wslink")},getInfo:function(){return{longname:"Wikispaces link",author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",
...
height:340,uiSetup:function(a){c("#closePreviewButton").click(function(){a.close()})}});this.registerPlugin({options:{id:"glogster",name:"Glogster",type:"media",category:"poster",logo:"/i/glogster_widget_160x70.jpg",url:"/web/20130128163946/http://edu.glogster.com/?page=wiki_spaces&wikiaction=login",homepage_url:"/web/20130128163946/http://edu.glogster.com",terms_url:"/web/20130128163946/http://edu.glogster.com/terms-of-use"}})},setPlugin:function(a){this.plugin=a},onShow:function(a){this.setPlugin(a.plugin);this.resetMediaForms();a.plugin&&(a.plugin.editor.plugins.wsreference?
...
(c("#anchorName").val(b[1]),c("#anchorMediaMenuEntry").click()):a.mediaString?this.loadMedia(a.mediaString):this.setMediaMenu("wikispaces")},loadMedia:function(a){document.genericMediaForm.media.value=a;document.genericMediaForm.submit()},addWidget:function(a,b){this.plugin.insertWidget(a,b);c("#mediaDiv .cancelMediaLink").eq(0).click()},setMediaError:function(a){c("#mediaError").show().text(a)},resetMediaForms:function(){c("#mediaDiv .mediaForm").each(function(){this.reset()});c("#mediaDiv .s2_autocompletePage").not("#includePageMediaMenu input").val(wikispaces_page).select2("val",
{id:wikispaces_page,text:wikispaces_page});c(".s2_autocompleteLink").select2("val",{id:"",text:""});wikispaces_isMain&&"www"==wikispaces_spaceName&&c("#mediaDiv .s2_autocompletePage").not("#includePageMediaMenu input").attr("readonly","readonly").select2("disable");c("#mediaDiv .s2_autocompleteWiki").select2("val",{id:wikispaces_wikiName,text:wikispaces_wikiName});c("#mediaError").hide().html("")},setMediaPreview:function(a){this.editor.plugins.wspopup.show("mediaPreview");c("#mediaPreviewArea").html(a)},
startMediaSpinner:function(){this.previousSection=this.currentSection;this.setMediaMenu("spinner");c("#mediaError").hide().html("")},stopMediaSpinner:function(){this.setMediaMenu(this.previousSection)},valuesChanged:function(){c("input").change()},setMediaMenu:function(a){ws.common.log("setMediaMenu",a);var b=!1;1==c("#"+a+"MediaMenuEntry").parents("#mediaMenu").length&&(c("#"+this.currentMenu+"MediaMenuEntry").removeClass("selected"),c("#"+a+"MediaMenuEntry").addClass("selected"),this.currentMenu=
a,b=!0);"showcustom"==a&&(a="custom");document.getElementById(a+"MediaMenu")||(a="wikispaces");ws.autocomplete.getAutocompleters(c("#"+a+"MediaMenu")).each(function(){var a=this.autocompleter;setTimeout(function(){a.findValue()},1)});c("#"+this.currentSection+"MediaMenu").hide();c("#"+a+"MediaMenu").show();this.currentSection=a;b&&"custom"!=a||"wikispaces"==a||"spinner"==a||"flickr"==a||"gabbly"==a||"yackpack"==a||"bittybrowser"==a||"toc"==a||"reference"==a||"facebooklike"==a||"googleplusone"==a||
"digg"==a||"reddit"==a||"anchor"==a||"include"==a.substring(0,7)||c("#"+a+"MediaMenu").is(".hideTextMediaInstructions")?c(document.otherMediaForm).hide():c(document.otherMediaForm).show();"spinner"!=a&&(document.otherMediaForm.mediaType.value=a);c("#"+a+"MediaMenu").find('input[type="text"],textarea').eq(0).focus();this.editor.plugins.wspopup.resize("mediaTool")},submitYackpack:function(){var a="/web/20130128163946/http://www.yackpack.com/walkietalkie/?"+encodeURIComponent(document.yackpackMediaForm.channel.value);document.otherMediaForm.embedText.value=
a;document.otherMediaForm.save.click()},submitBittyBrowser:function(){document.otherMediaForm.embedText.value='bitty browser\nwebsite: "'+document.bittybrowserMediaForm.url.value+'"';document.otherMediaForm.save.click()},embedGabbly:function(){document.otherMediaForm.embedText.value="<iframe src='/web/20130128163946/http://cw.gabbly.com/gabbly/cw.jsp?e=1&t="+encodeURIComponent(location.protocol+"//"+location.host+"/"+wikispaces_page)+"' scrolling='no' style='width:300px; height:250px;' frameborder='0'></iframe>";document.otherMediaForm.save.click()},
embedFacebookLike:function(){document.otherMediaForm.embedText.value='<iframe src="//www.facebook.com/plugins/like.php?href='+encodeURIComponent(location.protocol+"//"+location.host+"/"+wikispaces_page)+'&amp;send=false&amp;layout=standard&amp;width=450&amp;show_faces=true&amp;action=like&amp;colorscheme=light&amp;font&amp;height=80&amp;appId=XXX" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:80px;" allowTransparency="true"></iframe>';document.otherMediaForm.save.click()},
embedGooglePlusOne:function(){document.otherMediaForm.embedText.value='<g:plusone annotation="inline"></g:plusone>';document.otherMediaForm.save.click()},embedDigg:function(){document.otherMediaForm.embedText.value='<a class="DiggThisButton DiggMedium" src="/web/20130128163946/http://digg.com/submit?url='+encodeURIComponent(location.protocol+"//"+location.host+"/"+wikispaces_page)+'"></a>';document.otherMediaForm.save.click()},embedReddit:function(){document.otherMediaForm.embedText.value='<script type="text/javascript" src="/web/20130128163946/http://www.reddit.com/static/button/button1.js"><\/script>';
document.otherMediaForm.save.click()},uiSetup:function(a){var b=this,d=function(){a.close();return!1};c("#widgetCloseButton").click(d);c("#mediaDiv ul li").live("click",function(){var c=this.id,c=c.substring(0,c.indexOf("MediaMenuEntry"));"spinner"!=b.currentMenu&&(b.setMediaMenu(c),a.resize());return!1});c("#tocMediaForm #tocSubmitButton").click(function(){b.plugin.insertToc();return d()});c("#tocMediaForm #flatSubmitButton").click(function(){b.plugin.insertToc(!0);return d()});c("#referenceMediaForm").submit(function(a){b.plugin.insertReference();
a.preventDefault();a.stopPropagation();return d()});c("#referencesMediaForm").submit(function(a){b.plugin.insertReferences();a.preventDefault();a.stopPropagation();return d()});c("#anchorMediaForm").submit(function(a){var e=c("#anchorName").val();if(e.match(/^[^\]\|]+$/))return b.plugin.insertAnchor(e),a.preventDefault(),a.stopPropagation(),d();e?alert('Anchors may not contain the characters "|" or "]".'):alert("Please enter a name for the anchor.");a.preventDefault();a.stopPropagation();return!1});
c("#mediaDiv .mediaForm").submit(function(){b.startMediaSpinner()});c("#bittybrowserMediaForm").submit(function(){b.submitBittyBrowser()});c("#gabblyMediaForm").submit(function(a){b.embedGabbly();a.preventDefault();a.stopPropagation();return!1});c("#yackpackMediaForm").submit(function(a){b.submitYackpack();a.preventDefault();a.stopPropagation();return!1});c("#codeMediaForm").submit(function(a){c(f.activeEditor.selection.getNode()).closest("pre").length?(alert("You cannot insert a code block inside another code block"),
b.stopMediaSpinner()):(b.plugin.insertCode(document.codeMediaForm.code.value,document.codeMediaForm.format.value),d());a.preventDefault();a.stopPropagation();return!1});c("#facebooklikeMediaForm").submit(function(a){b.embedFacebookLike();a.preventDefault();a.stopPropagation();return!1});c("#googleplusoneMediaForm").submit(function(a){b.embedGooglePlusOne();a.preventDefault();a.stopPropagation();return!1});c("#diggMediaForm").submit(function(a){b.embedDigg();a.preventDefault();a.stopPropagation();
...
c("#rssDescInput").change(function(){this.checked?(c("#rssDescRow input").prop("disabled",!1),c("#rssDescRow th").removeClass("disabled")):(c("#rssDescRow input").prop("disabled",!0),c("#rssDescRow th").addClass("disabled"))});if(!(c.browser.msie&&8>parseInt(c.browser.version))){var e=function(a){return a.title?ws.common.escapeHtml(a.title):a.text?ws.common.escapeHtml(a.text):""};c(".s2_autocompleteWiki").select2({width:"240px",placeholder:{title:"Select a wiki",id:""},createSearchChoice:function(a){a=
a.replace(/,/,"");return{id:a,text:a}},ajax:{url:"/wiki/autocomplete",dataType:"text",data:function(a,b){return{q:a,p:b,n:10}},results:function(a){a=_(a.split("\n")).chain().compact().map(function(a){a=a.split("|");return{text:a[1],id:a[0]}}).value();return{results:a,more:10==a.length}}},initSelection:function(a){return{id:c(a).val(),text:c(a).val()}},formatSelection:e,formatResult:e});c(".s2_autocompleteLink").select2({width:"240px",placeholder:{title:"Select a page",id:""},createSearchChoice:function(a){a=
a.replace(/,/,"");return{id:a,text:a}},ajax:{url:ws.common.pathFor("space","autocompletepage",wikispaces_wikiName,"P"),dataType:"text",data:function(a,b){return{w:c(".s2_autocompleteWiki").val(),q:a,p:b,n:10}},results:function(a){a=_(a.split("\n")).chain().compact().map(function(a){a=a.split("|");return{text:a[0],id:a[0],iconUrl:a[4]}}).value();return{results:a,more:10==a.length}}},initSelection:function(a){return{id:c(a).val(),text:c(a).val()}},formatSelection:ws.select2.formatObject,formatResult:ws.select2.formatObject});
c(".s2_autocompletePage").select2({width:"240px",placeholder:{title:"Select a page",id:""},createSearchChoice:function(a){a=a.replace(/,/,"");return{id:a,text:a}},ajax:{url:ws.common.pathFor("space","autocompletepage",wikispaces_wikiName,"P"),dataType:"text",data:function(a,b){return{q:a,p:b,n:10}},results:function(a){a=_(a.split("\n")).chain().compact().map(function(a){a=a.split("|");return{text:a[0],id:a[0],iconUrl:a[4]}}).value();return{results:a,more:10==a.length}}},initSelection:function(a){return{id:c(a).val(),
text:c(a).val()}},formatSelection:ws.select2.formatObject,formatResult:ws.select2.formatObject})}c.each(this.customPlugins,function(){if("media"==this.options.type){var a=c("<a>").attr("href","#widget-"+this.options.id).text(this.options.name),a=c("<li>").attr("id",this.options.id+"MediaMenuEntry").append(a);c("#"+this.options.category+"MediaMenu ul li:last").before(a);a=document.location.protocol+"//"+document.location.host+ws.common.pathFor("site","editorplugin",this.options.id);a=ws.common.addUriParams(this.options.url,
[[b.COMMAND_URL_PARAM,a]]);a=c("<div>").attr("id",this.options.id+"MediaMenu").addClass("hideTextMediaInstructions").addClass("mediaInstructions").hide().html('<div><iframe class="pluginIframe" frameborder="0" src="'+a+'" id="'+this.options.id+'-pluginIframe" name="'+this.options.id+'-pluginIframe"></iframe><p class="mediaInstructionsTerms">The content above is provided by <a href="'+this.options.homepage_url+'" target="_blank">'+this.options.homepage_url+'</a> and is governed by their <a href="'+
this.options.terms_url+'" target="_blank">terms of service</a>.</p></div>');c("#mediaDiv").find(".mediaInstructions:last").after(a)}})},runCustomPluginCommand:function(a,b,d){switch(a){case "cancel":c("#mediaDiv .cancelMediaLink").click();break;case "preview":this.setMediaPreview(d.content);break;case "submit":document.otherMediaForm.embedText.value=d.content;document.otherMediaForm.mediaType.value=b;document.otherMediaForm.save.click();break;default:alert("The "+b+" plugin requested an invalid operation.")}},
registerPlugin:function(a){this.customPlugins[this.customPlugins.length]=a}});f.PluginManager.add("wswidgetpopup",wikispaces.popups.Widget)})(tinymce,jQuery);
(function(f,c){f.create("wikispaces.plugins.LinkOverlay",{init:function(a){var b=this;this.editor=a;this.overlay=null;a.onInit.add(function(a){var c=function(a){a.onClick.add(function(a,c){"A"==c.target.nodeName?b.show(c.target):b.hide()})};a.onInitSubEditor.add(c);c(a)});a.onModeSwitch.add(function(a){"plain"==a&&b.hide()});c(window).resize(function(){b.link&&c(b.link).is(":visible")&&b.repositionAndShow()})},getInfo:function(){return{longname:"Wikispaces link overlay",author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",
...
(function(f,c){f.create("wikispaces.popups.Image",{MAX_PER_ROW:8,MAX_ROWS:8,PER_PAGE:6,IMAGE_SIZE:32,externalPosition:0,currentMode:"all",newUploads:[],plugin:null,editor:null,tagFilter:null,fileSource:"",init:function(a){var b=this;b.editor=a;a.plugins.wspopup.register({wsname:"imageTool",title:"Images and Files",width:670,height:387,wsselection:0,onShow:function(a){b.onShow(a)},uiSetup:function(a){b.uiSetup(a)}})},onShow:function(a){this.showPage(1);this.setPlugin(a.plugin);this.uploader&&this.uploader.refresh()},
...
var h=ws.common.pathFor("file","listjson",this.currentMode);this.fileSource&&(h=(match=this.fileSource.match(/(.*)\*$/))?match[1]+"file/listjson/"+this.currentMode+"?allTeams=1":this.fileSource+"file/listjson/"+this.currentMode);c.ajaxq("imageList");c.ajaxq("imageList",{url:h,type:"GET",cache:!1,data:{offset:d,pageLimit:e,filename:g,tag:this.tagFilter.getTags(),sources:c("#fileSourcesList").length?"":"t"},dataType:"json",global:!1,error:function(){ws.session.reloadSession(function(){b.showPage(a)},
3E3,function(){f.activeEditor.plugins.wscommon.sessionReloadFailed()})},success:function(a){ws.session.reloadSessionSuccess();b.loadFileData(a);b.editor.plugins.wspopup.resize("imageTool");a.sources&&b.buildSourcesList(a.sources,a.currentSource)}})},buildSourcesList:function(a,b){$fileSources=c("<select/>",{id:"fileSourcesList"});_.each(a,function(a,d){$option=c("<option/>",{value:d}).text(a).appendTo($fileSources);d==b&&$option.prop("selected",!0)});c(".filterSourcesDrop").append($fileSources);c(".filterSources").show();
var d=this;$fileSources.change(function(){d.fileSource=c(this).val();d.resetPages();d.showPage(1)})},showFileSpinner:function(){c("#filenameAutocomplete").css("background","white url('/i/spinner.gif') no-repeat center right")},hideFileSpinner:function(){c("#filenameAutocomplete").css("background-image","none")},setListMode:function(a){c("#fileListMode").val(a);this.currentMode=a;this.tagFilter.setMode(a);this.showPage(1);this.tagFilter.showPage(1)},getCell:function(a,b){return c("#"+a+" tr").eq(Math.floor(b/
this.MAX_PER_ROW)).find("td").get(b%this.MAX_PER_ROW)},addRow:function(a){var b=document.createElement("tr");for(j=0;j<this.MAX_PER_ROW;j++)b.appendChild(document.createElement("td"));c("#"+a).append(b)},addFileRow:function(a,b,d,e,g,h,k,l,m){var n=this,o=null;"image"==e||this.isImage(e)||"application/vnd.google-apps.drawing"==e?o="image":this.isAudio(e)?o="audio":this.isVideo(e)&&(o="video");li1=c("<li>").attr("title",d).addClass("active");m||li1.click(function(){n.plugin.insertImageInEditor(b,d,
o,null,h,k);n.editor.plugins.wspopup.hide("imageTool")});a=document.createElement("img");m?(a.src="/i/c.gif",a.width=n.IMAGE_SIZE,a.height=n.IMAGE_SIZE):"image"==o&&l?(a.src=l,a.height>a.width?(a.width=a.width/a.height*n.IMAGE_SIZE,a.height=n.IMAGE_SIZE):(a.height=a.height/a.width*n.IMAGE_SIZE,a.width=n.IMAGE_SIZE)):(l=(h?h:"")+ws.common.encodePath(b,"thumbnail",d),a.src=l+"?size="+n.IMAGE_SIZE+(m?"&rnd="+Math.random():""),a.width=n.IMAGE_SIZE,a.height=n.IMAGE_SIZE);c(li1).append(a).append(c('<div class="fileName">').text(ws.common.truncify(d,
40)));m=f.mainEditor.getParam("wsimage_page_view_group");1==ws.common.compareGroupPermissionValues(g,m)&&c('<img src="/i/icon_16_hidden.png"/>').css({"float":"right","padding-top":6}).attr("title","This file has more restrictive permissions than this page. Some users may not be able to see it.").attr("alt","This file has more restrictive permissions than this page. Some users may not be able to see it.").appendTo(li1);c(".fileList ul").append(li1);return li1},addFileCell:function(a,b,d,e,g,f){var k=
this,d=this.getCell(a,e);d||(this.addRow(a),d=this.getCell(a,e));a=document.createElement("td");a.style.textAlign="center";a.style.padding="5px;";a.title=b;c(a).click(function(){k.plugin.insertImageInEditor("external",b,"image",g);k.editor.plugins.wspopup.hide("imageTool")});f||(f=document.createElement("img"));g&&(f.src=g,f.height>f.width?(f.width=f.width/f.height*k.IMAGE_SIZE,f.height=k.IMAGE_SIZE):(f.height=f.height/f.width*k.IMAGE_SIZE,f.width=k.IMAGE_SIZE));c(f).appendTo(a);d.parentNode.replaceChild(a,
d)},resetPages:function(){var a=this;c("#imagePages").html('<a href="#" class="pageNumber pageCurrent" style="visibility: hidden;">&nbsp;</a>');var b=1,d=this.pageCount;7<this.pageCount&&(b=this.currentPage-1,1>b&&(b=1),d=b+1,d>this.pageCount&&(d=this.pageCount));for(var e=1+d-b+(d==this.pageCount?0:1)+(1==b?0:1),g=0;7>e&&(1!=b||d!=this.pageCount);)g%2?(b--,1>b&&(b=1)):(d++,d>this.pageCount&&(d=this.pageCount)),g++,e=1+d-b+(d==this.pageCount?0:1)+(1==b?0:1);if(1<this.pageCount){1==this.currentPage?
c("#imagePages").append('<span class="pageFirst inactive">&laquo; Previous</span>'):(e=c('<a href="#" class="pageFirst">&laquo; Previous</a>').click(function(){a.showPage(a.currentPage-1)}),c("#imagePages").append(e));1<b&&(this.addPage(1),2<b&&c("#imagePages").append(" ... "));for(g=b;g<=d;g++)this.addPage(g);this.pageCount>d&&(d+1<this.pageCount&&c("#imagePages").append(" ... "),this.addPage(this.pageCount));this.currentPage==this.pageCount?c("#imagePages").append('<span class="inactive">Next &raquo;</span>'):
(b=c('<a href="#">Next &raquo;</a>').click(function(){a.showPage(a.currentPage+1)}),c("#imagePages").append(b))}},loadFileData:function(a){var b=this;c(".fileList ul").empty();var d=0;if("myrecent"==this.currentMode){var e=(b.currentPage-1)*b.PER_PAGE;c.each(this.newUploads,function(a,g){if(!(a<e)){if(d>=b.PER_PAGE)return!1;var f=b.addFileRow("imageTable",g.f_type,g.f_name,g.r_mime_type,g.f_view_group,g.f_location,g.f_context,null,!0);c(f).attr("id","swfu_file_"+g.id).find("div.fileName").append("&nbsp;&nbsp;").append(c("<a>").attr("href",
"#").addClass("uploadCancelButton").attr("id",g.id+"cancel").text("cancel").click(function(a){f.remove();b.uploader.removeFile(b.uploader.getFile(g.id));a.preventDefault()})).append('<div class="progressContainer"><div class="progressBar" id="'+g.id+'progress"></div></div>');d++}})}c.each(a.files,function(a,c){if(d>=b.PER_PAGE)return!1;b.addFileRow("imageTable",c.f_type,c.f_name,c.r_mime_type,c.f_view_group,c.f_location,c.f_context);d++});if(!d){var g=c("<li>").text("No files found").addClass("nodata");
c(".fileList ul").append(g);d++}for(;d<this.PER_PAGE;){var g=document.createElement("li"),f=document.createElement("img");f.src="/i/c.gif";f.height=b.IMAGE_SIZE;f.width=b.IMAGE_SIZE;g.appendChild(f);g.appendChild(document.createTextNode(" "));c(".fileList ul").append(g);d++}this.pageCount=a.pagedata.numpages;this.currentPage=a.pagedata.current;this.resetPages();this.highlightPage(this.currentPage);this.hideFileSpinner()},highlightPage:function(a){c("#imagePages a.pageNumber").each(function(){c(this).html()==
a?c(this).addClass("pageCurrent"):c(this).removeClass("pageCurrent")})},externalImageOnloadCallback:function(){},showExternalImage:function(){var a=this,b=document.getElementById("externalImageUrl").value;if(b){var d=c("<img/>");d.one("load",function(){if(0==d[0].height)alert("The external image could not be found.");else{var c=b.match(/.*\/([^\/\?]+)/)[1];a.addFileCell("externalTable",c,"image",a.externalPosition++,b,d[0])}});d.one("error",function(){alert("The external image could not be found.")});
d.attr("src",b)}else alert("Please enter the address of an external image.")},uiSetup:function(a){var b=this;c("#imageCloseButton").click(function(){a.close();return!1});for(i=0;i<this.MAX_ROWS;i++)this.addRow("externalTable");ws.session.reloadSessionAt(0);ws.common.inputHint(c("#imageDivTable .fileNameField"));c("#fileListMode").change(function(){b.setListMode(c(this).val())});(!wikispaces_isUserLoggedIn||!wikispaces_isUploadCapable)&&c("#uploadButtons button").prop("disabled",!0);c("#externalTabCell button").click(function(){b.showExternalImage();
return!1});c("#imageDiv .modeSelector li.tab").click(function(){c("#imageDiv .modeSelector li.tab").removeClass("selected");c(this).addClass("selected");c("#imageDiv .fileMode").hide();c("#imageDiv").find("#"+c(this).attr("id")+"Cell").show()});ws.common.inputHint(c("#filenameAutocomplete"));c("#filenameAutocomplete").keyup(function(){b.showPage(1);b.tagFilter.showPage(1)});wikispaces_username&&c("#fileListMode").append('<option value="myrecent">My Recent Uploads</option>');ws.autocomplete.registerAutocompleters(c("#imageDiv"));
this.tagFilter=ws.cob.initFilter(c("#imageDiv .filterWrapper"),{tagChangeCallback:function(){b.showPage(1)},sessionFailCallback:function(){f.activeEditor.plugins.wscommon.sessionReloadFailed()},tagPageChangeCallback:function(){a.resize()}});-1!=navigator.platform.indexOf("Mac")&&c("#ctrlKeyName").html("&#8984;");wikispaces_isUserLoggedIn&&this.setupUploader()},setupUploader:function(){var a=this,b=f.mainEditor;this.uploader=new plupload.Uploader({runtimes:_(ws.common.pluploadRuntimes()).without("silverlight").join(","),
browse_button:"uploadFiles",url:b.getParam("wsimage_upload_url"),flash_swf_url:"/s/plupload.flash.swf",silverlight_xap_url:"/s/plupload.silverlight.xap",multipart_params:Cookie.all(),max_file_size:b.getParam("wsimage_max_file_size_mb")+"MB",drop_element:"imageDivTable",container:"uploadButtons"});this.uploader.init();this.uploader.bind("FilesAdded",function(b,d){_(d).each(function(b){var c="application/octet-stream";a.isImageFilename(b.name)&&(c="image");a.newUploads.push({f_name:b.name,r_mime_type:c,
id:b.id})});a.setListMode("myrecent");c("#imageDivTable .filterTagShow").effect("highlight",{},3E3);c("#filenameAutocomplete").val("");c("#imageDiv .WikiTokenAutocomplete .closebutton").click();c("#uploadFiles").hide();c("#cancelQueueBtn").show();b.refresh();b.start()});this.uploader.bind("UploadProgress",function(a,b){c("#swfu_file_"+b.id).find(".progressBar").css("width",b.percent+"%")});this.uploader.bind("FileUploaded",function(a,b){c("#swfu_file_"+b.id).attr("id","").find(".progressContainer").remove();
c("#"+b.id+"cancel").remove()});var d=function(){a.newUploads=[];c("#cancelQueueBtn").hide();c("#uploadFiles").show();$iframe=c("<iframe>").css({width:0,height:0,border:0}).attr("src",ws.common.pathFor("file","upload")+"?multiModeConfirm=1&remoteMode=true").bind("load",function(){a.setListMode("myrecent");c("#filenameAutocomplete").val("");c("#imageDiv .WikiTokenAutocomplete .closebutton").click()}).appendTo(document.body)};this.uploader.bind("UploadComplete",d);c("#cancelQueueBtn").click(function(){a.uploader.stop();
d()});this.uploader.bind("Error",function(a,d){ws.common.logFileUploadError(d,b.getParam("wsimage_max_file_size_mb")+"MB");d.file&&c("#"+d.file.id).length&&c("#"+d.file.id).removeClass("fileUploading").addClass("uploadError");a.refresh()})},isImage:function(a){switch(a){case "image/png":case "image/x-png":case "image/jpeg":case "image/gif":case "image/jpg":case "image/pjpeg":return!0}return!1},isImageFilename:function(a){return a.match(/.*\.(?:gif|jpg|jpeg|png)$/i)},isMedia:function(a){return this.isAudio(a)||
this.isVideo(a)},isAudio:function(a){switch(a){case "audio/mpeg":case "audio/mpg":case "audio/mp3":case "audio/x-mp3":case "audio/x-mpeg":case "audio/x-mpg":case "application/asx":case "application/x-mplayer2":case "audio/x-ms-wma":case "audio/x-ms-wax":case "audio/3gpp":case "audio/3gpp2":case "audio/aac":case "audio/x-aac":case "audio/aiff":case "audio/x-aiff":case "audio/mid":case "audio/midi":case "audio/x-midi":case "audio/mp4":case "audio/m4a":case "audio/x-m4a":case "audio/wav":case "audio/x-wav":case "audio/x-pn-realaudio":case "audio/x-pn-realaudio-plugin":return!0}return!1},
...
author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",infourl:"/web/20130128163946/http://wikispaces.com",version:"0.1"}},error:function(){ws.common.track("Editor","Start","Inline Failure");ws.editor._editorDeferred.reject();document.location=ws.common.pathFor("page","edit",wikispaces_page)},loadData:function(a){a=c(a);try{var b=a.find("checkout checkoutStatus").text(),d=a.find("checkout checkoutUser").text(),e=a.find("checkout checkoutDate").text(),g=a.find("checkout checkoutRefreshDate").text();this.checkout(b,d,
e,g);var f;f=parseInt(a.find("dump contentChanged").text())?a.find("dump content").text():this.convertHtml();var k=a.find("dump version").text(),l=a.find("dump editorCleanup").text(),m=JSON.parse(a.find("dump pageComments").text());this.loadVersion(f,m,k,l);var n=a.find("dump autosave autosaveContent").text(),o=a.find("dump autosave autosaveDate").text(),p=a.find("dump autosave autosaveVersion").text(),q=a.find("dump autosave autosaveCleanup").text(),t=a.find("dump autosave autosaveAge").text(),s=
a.find("dump autosave autosaveConflict").text(),r=(m=a.find("dump autosave autosavePageComments").text())?JSON.parse(m):{};this.autoload(n,r,o,p,q,t,s);ws.common.track("Editor","Start","Inline")}catch(u){this.error()}},checkout:function(a,b){if("locked"==a&&(!wikispaces_isUserLoggedIn||b!=wikispaces_username))alert(this.checkoutMessage),document.location=ws.common.pathFor(wikispaces_page)},loadVersionFromForm:function(){var a=c("#wsMainEditor").val(),b=JSON.parse(this.editor.plugins.wscommon.getOption("pageComments")),
...
b[1]):this.resetSpanStyleStrike()},updatePreviewStyle:function(){"none"!=c(".styleBasic").css("display")&&this.mergeBasicStyleToAdvanced();var a=c.trim(document.styleForm.styleText.value).replace(/;?\n/gmi,"; ");c("#stylePreviewApplied").attr("style",a)},mergeBasicStyleToAdvanced:function(){var a=c(document.styleForm.styleText).val(),b=c(document.styleForm.styleSize).val(),d=c(document.styleForm.styleFont).val(),e=c(document.styleForm.styleColor).val(),g=c(document.styleForm.styleBackgroundColor).val(),
f=c(document.styleForm.styleAlignment).val(),k=c(document.styleForm.styleVertical).val(),l=c(document.styleForm.styleStrike).prop("checked"),a=b&&"100%"!=b?a.match(/^\s*font-size:\s*.*$/gmi)?a.replace(/^\s*font-size:\s*.*$/gmi,"font-size: "+b+";"):a+"\nfont-size: "+b+";":a.replace(/^\s*font-size:\s*.*$/gmi,""),a=d?a.match(/^\s*font-family:\s*.*$/gmi)?a.replace(/^\s*font-family:\s*.*$/gmi,"font-family: "+d+";"):a+"\nfont-family: "+d+";":a.replace(/^\s*font-family:\s*.*$/gmi,""),a=e?a.match(/^\s*color:\s*.*$/gmi)?
a.replace(/^\s*color:\s*.*$/gmi,"color: "+e+";"):a+"\ncolor: "+e+";":a.replace(/^\s*color:\s*.*$/gmi,""),a=g?a.match(/^\s*background-color:\s*.*$/gmi)?a.replace(/^\s*background-color:\s*.*$/gmi,"background-color: "+g+";"):a+"\nbackground-color: "+g+";":a.replace(/^\s*background-color:\s*.*$/gmi,"");f?(a=a.match(/^\s*text-align:\s*.*$/gmi)?a.replace(/^\s*text-align:\s*.*$/gmi,"text-align: "+f+";"):a+"\ntext-align: "+f+";",a.match(/^\s*display:\s*block;\s*$/gmi)||(a+="\ndisplay: block;")):(a=a.replace(/^\s*text-align:\s*.*$/gmi,
...
"Add File",b),this.insertImageInEditorCallback(a,b,d,e,f,h)},insertImageInEditorCallback:function(a,b,d,e,g,h,k){var g=f.activeEditor,l="",m="newImage-"+wikispaces.plugins.ImagePlugin.newImageIdCounter++,n=m,l=h&&this.isLocalContext(h)?"":h,o,p,q,t;if("file"==a)o="view",p="WikiMediaFile",q="WikiFile",t="File";else if("doc"==a)o="viewfile",p="WikiMediaDoc",q="GoogleDoc",t="Google Doc";else if("external"!=a)return;"image"==d?(p="",800<k.width()&&(p=' width="800" height="'+Math.floor(800/k.width()*k.height())+
...
author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",infourl:"/web/20130128163946/http://wikispaces.com",version:"0.1"}},getNextRefId:function(){return++this.nextRefId},elementIdToRefId:function(a){return a.match(/-(\d+)$/)[1]},pullOutReferences:function(a){var b=!1,c=this;a.content=a.content.replace(/(&lt;ref(?:&gt;|>)((?:.|\n)*?)&lt;\/ref(?:&gt;|>))|(<pre\s+.*?>)|(<\/pre>)/gmi,function(a,f,h,k,l){if(f&&!b)return a=c.getNextRefId(),f=c.makeReferenceHtml(a),c.addReferenceEditor(a,h),f;k?b=!0:l&&(b=!1);return a})},
...
id:""},createSearchChoice:function(a){a=a.replace(/,/,"");return{id:a,text:a}},ajax:{url:"/wiki/autocomplete",dataType:"text",data:function(a,b){return{q:a,p:b,n:10}},results:function(a){a=_(a.split("\n")).chain().compact().map(function(a){a=a.split("|");return{text:a[1],id:a[0]}}).value();return{results:a,more:10==a.length}}},formatSelection:d,formatResult:d});c("#linkPageName").select2({placeholder:{title:"Find a page, file, or doc",id:""},createSearchChoice:function(a){a=a.replace(/,/,"");return{id:"page:"+
a,text:a}},ajax:{url:ws.common.pathFor("space","autocompletepage"),dataType:"text",data:function(a,b){return{w:c("#linkWikiName").val(),q:a,p:b,n:10}},results:function(a){a=_(a.split("\n")).chain().compact().map(function(a){a=a.split("|");return{text:a[0],id:a[2]+":"+a[0],iconUrl:a[4]}}).value();return{results:a,more:10==a.length}}},formatSelection:ws.select2.formatObject,formatResult:ws.select2.formatObject});c("#linkPageName").change(function(){var a;if(a=c(this).val().match(/^(?:\w+\:)?(.*\/)$/))c(this).select2("open"),
...
a.onNodeChange.add(function(a,b,f){ws.editor.content.isLoaded&&b.setDisabled("wsstyle",a.wsselection&&a.wsselection.withinCode());b.setActive("wsstyle",0<c(f).closest("span,div,font,strike,s").length)});a.plugins.wscommon.disableUntilLibsLoad(a,"wsstyle")},getInfo:function(){return{longname:"Wikispaces style",author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",infourl:"/web/20130128163946/http://wikispaces.com",version:"0.1"}},applyStyle:function(){ws.common.track("Editor","Apply Style");var a=c(document.styleForm.styleText).val(),
...
a.plugins.wscommon.cursorToAndRemoveElement(c("#wsHold",a.getDoc()).get(0));h&&"\n"==g.text().substr(-1)&&(a.selection.setContent('\n<span id="wsHold"></span>'),a.plugins.wscommon.cursorToAndRemoveElement(c("#wsHold",a.getDoc()).get(0)));b.preventDefault();b.stopPropagation();return!1}}});a.plugins.wscommon.disableUntilLibsLoad(a,"wswidget")},getInfo:function(){return{longname:"Wikispaces widgets",author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",infourl:"/web/20130128163946/http://wikispaces.com",version:"0.1"}},
...
ws.math.process("previewBox")})},hidePreview:function(){c("#previewBox").remove();this.editor.theme.showToolSet();c(".mceToolbar.spinner").remove();c(".mceToolbar").show();this.showEditor();WikispacesCommentManager.removeSpace(this.previewSpace);WikispacesCommentManager.restoreSpaces(this.commentSpaces);WikispacesCommentManager.readOnly=!1;"visual"==this.editor.plugins.wscommon.getOption("mode")?(WikispacesCommentManager.redrawAll(!0),WikispacesCommentManager.forceWidth()):WikispacesCommentManager.hideAll()},
getPreviewData:function(a,b,d){var e=this,f=c("<div></div>").attr("id","previewSpinner").addClass("wikispaces_content").addClass("mceToolbar spinner").css({textAlign:"center"}).html('Loading Preview <img src="/i/spinner.gif" alt="" width="18" height="18" style="padding-top: 9px; vertical-align: -4px;"/>');c(".mceToolbar").hide();c(e.editor.plugins.wscommon.editorToolbar()).append(f);c.ajax({url:ws.common.pathFor("page","preview",wikispaces_page),type:"POST",async:!0,cache:!1,data:{content:a,mode:b},
dataType:"xml",global:!1,error:function(){ws.session.reloadSession(function(){e.showPreview()},3E3,function(){e.editor.plugins.wscommon.sessionReloadFailed();c(".mceToolbar.spinner").remove();c(".mceToolbar").show()})},success:function(a){ws.common.log("showPreviewResponse",a);ws.session.reloadSessionSuccess();a=c(a);a.find("preview").length&&d(a.find("preview").text());c(".mceToolbar.spinner").remove();c(".mceToolbar").show();a.find("preview").length||(a.find("error").length?(a=a.find("error").attr("message"),
alert(a)):alert("An unexpected error occurred."))}})},hideEditor:function(){this.bookmark=null;try{this.bookmark=this.editor.selection.getBookmark(2)}catch(a){}c(".WikiOverlay").hide();this.frameHeight=c(this.editor.plugins.wscommon.editorIFrame()).height();c(this.editor.getContentAreaContainer()).hide();c("#referenceEditors").hide()},showEditor:function(){c(this.editor.getContentAreaContainer()).show();c(this.editor.plugins.wscommon.editorIFrame()).height(this.frameHeight);c("#referenceEditors").show();
var a=this;setTimeout(function(){try{a.bookmark&&a.editor.selection.moveToBookmark(a.bookmark)}catch(b){}a.editor.focus();a.editor.wsselection.ensureCursor()},100)}});f.PluginManager.add("wspreview",wikispaces.plugins.PreviewPlugin)})(tinymce,jQuery);
...
a.onModeSwitch.add(function(a){"visual"==a?_.defer(function(){WikispacesCommentManager.showAll()}):"plain"==a&&WikispacesCommentManager.hideAll()})},getInfo:function(){return{longname:"Wikispaces comment",author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",infourl:"/web/20130128163946/http://wikispaces.com",version:"0.1"}},isAutoSaveComments:function(a){return _(a).any(function(a){return _.isString(a)})},loadComments:function(a){this.isAutoSaveComments(a)?WikispacesCommentManager.retrieveData(function(){_(a).each(function(a,
...
f.isIE&&a.dom.bind(a.getDoc(),"controlselect",function(b){jQuery(b.srcElement).is("img,pre")&&a.onClick.dispatch(a,b)})});var e=!1;a.onKeyDown.add(function(a,b){if(!b.ctrlKey&&!b.altKey&&("9"==b.keyCode&&(b.preventDefault(),b.stopPropagation()),8==b.keyCode||46==b.keyCode))e=!a.selection.isCollapsed()});a.onKeyUp.add(function(a,b){(8==b.keyCode||46==b.keyCode)&&e&&a.undoManager.add()});f.isWebKit&&a.onKeyUp.add(function(a,b){if((8==b.keyCode||46==b.keyCode)&&e&&""==jQuery.trim(jQuery(a.getBody()).text())&&
a.dom.isBlock(jQuery(a.getBody()).children().get(0))){a.undoManager.begin();jQuery(a.getDoc().body).children().remove();var c=jQuery("<span>",a.getDoc()).appendTo(a.getDoc().body).after("<br/>");a.plugins.wscommon.cursorToAndRemoveElement(c);a.undoManager.end();a.undoManager.remove()}});a.onActivate.add(function(a){b.controlManager().editor=a;jQuery(a.getContentAreaContainer()).addClass("active_editor")});a.onDeactivate.add(function(a){a.initialized&&(jQuery(a.getContainer()).is(":visible")&&a.selection.collapse(),
jQuery(a.getContentAreaContainer()).removeClass("active_editor"))});a.onModeSwitch=new f.util.Dispatcher(a);a.onModeSwitch.add(function(a){f.each(c,function(a){b.controlManager().get(a.toLowerCase()).setActive(!1)});"plain"==a?jQuery("#switchEditorModes span.mceText").text("Visual Editor").attr("title","Visual Editor"):jQuery("#switchEditorModes span.mceText").text("WikiText Editor").attr("title","WikiText Editor");b.showToolSet()});a.setClean=function(){this.startContent=f.trim(this.getContent({format:"raw",
no_events:1}))};a.addCommand("wsInsertHorizontalRule",function(){f.isWebKit?a.execCommand("InsertHtml",!1,"<hr>"):a.execCommand("InsertHorizontalRule")});a.wsExecCommand=function(b,c,d,e){switch(b){case "Bold":case "Italic":case "Underline":case "wsFormatBlock":case "wsInsertHorizontalRule":case "wsInsertOrderedList":case "wsInsertUnorderedList":case "wslink":case "wsimage":case "wsTable":case "wsWidget":case "wsStyle":case "preview":case "endPreview":if("plain"==a.plugins.wscommon.getOption("mode")){this.execCommand(b+
"Text",c,d,e);break}default:this.execCommand(b,c,d,e)}}},controlManager:function(){return f.mainEditor.controlManager},getHeaderParent:function(a){a=this.editor.dom.getParents(a);for(i=0;i<a.length;i++)if(a[i].nodeName.toLowerCase().match(/h\d/))return a[i]},showToolSet:function(a){var b=jQuery("#wsMainEditor_tools1 td > *:first-child");switch(a){case "preview":b.css("visibility","hidden");jQuery("#wsMainEditor_wssave_action").css("visibility","visible");jQuery("#wsMainEditor_wssave_open").css("visibility",
"visible");jQuery("#wsMainEditor_wsendpreview").css("visibility","visible");jQuery("#wsMainEditor_wsendpreview").css(jQuery.browser.msie&&8<=jQuery.browser.version?{left:-60,top:7}:{right:170,top:28});jQuery.browser.webkit&&jQuery("#wsMainEditor_wsendpreview").parent().css("position","");break;default:b.css("visibility","visible"),jQuery("#wsMainEditor_wsendpreview").css("visibility","hidden"),"plain"==this.editor.plugins.wscommon.getOption("mode")&&(jQuery("#wsMainEditor_wscomment").css("visibility",
"hidden"),jQuery("#wsMainEditor_undo").css("visibility","hidden"),jQuery("#wsMainEditor_redo").css("visibility","hidden")),wikispaces_can_discuss||jQuery("#wsMainEditor_wscomment").css("visibility","hidden")}},renderUI:function(a){var b=this,d=b.editor,e=d.controlManager,g=c.insertAfter(c.create("div",{id:d.id+"_container","class":"mceEditor "+d.settings.skin+"Skin"}),a.targetNode),h=c.add(g,"div",{id:d.id+"_external","class":"mceExternalToolbar toolbarLayer"});c.insertAfter(c.create("div",{id:d.id+
"_overlay","class":"wsPopupModalBlocker blockerLayer",style:"display: block !important; "}),a.targetNode);b.toolbar=e.createToolbar("tools1");b.toolbar.add(e.createButton("bold",{title:"Bold",onclick:function(){f.activeEditor.wsExecCommand("Bold");ws.common.track("Editor","Bold")}}));b.toolbar.add(e.createButton("italic",{title:"Italic",onclick:function(){f.activeEditor.wsExecCommand("Italic");ws.common.track("Editor","Italic")}}));b.toolbar.add(e.createButton("underline",{title:"Underline",onclick:function(){f.activeEditor.wsExecCommand("Underline");
ws.common.track("Editor","Underline")}}));b.toolbar.add(e.createControl("wsstyle"));b.toolbar.add(e.createSeparator());var k=e.createListBox("formatlistbox",{title:"Format",onselect:function(a){f.activeEditor.wsExecCommand("wsFormatBlock",!1,a);ws.common.track("Editor","Select Font",a);jQuery("#wsMainEditor_formatlistbox").removeClass("mceListBoxSelected")}});k.onRenderMenu.add(function(a,b){b.onShowMenu.add(function(){f.activeEditor.wsselection.save(2);if(!b.alreadyRendered){b.alreadyRendered=!0;
var a=function(a){if(document.defaultView&&document.defaultView.getComputedStyle)return document.defaultView.getComputedStyle(a,"");if(a.currentStyle)return a.currentStyle},c=function(a,b,c){if(document.defaultView&&document.defaultView.getComputedStyle)for(var d=0;d<b.length;d++){var e=b[d],f=b.getPropertyValue(e),g=a.getPropertyValue(e);f&&f!=g&&jQuery(c).css(e,f)}else for(e in b)e=e.replace(/\-(\w)/g,function(a,b){return b.toUpperCase()}),f=b[e],g=a[e],f&&f!=g&&jQuery(c).css(e,f)};jQuery(document.body).append('<div class="wiki" style="display: none;" id="styleHolder"><h1>h1</h1><h2>h2</h2><h3>h3</h3><h4>h4</h4><h5>h5</h5><h6>h6</h6><span>span</span></div>');
jQuery("#styleHolder").children().each(function(){var b;b="span"==this.nodeName.toLowerCase()?jQuery("#menu_wsMainEditor_wsMainEditor_formatlistbox_menu .toolbar_formatmenu_normal .mceText"):jQuery("#menu_wsMainEditor_wsMainEditor_formatlistbox_menu .toolbar_formatmenu_"+this.nodeName.toLowerCase()+" .mceText");var d=a(jQuery("#styleHolder").get(0)),e=a(this);c(d,e,b.get(0));b.css("white-space","nowrap")})}});b.onHideMenu.add(function(){f.activeEditor.wsselection.restore();setTimeout(function(){f.activeEditor.focus()},
100)});b.settings.max_height=185});k.add("Heading 1","h1",{"class":"toolbar_formatmenu_h1"});k.add("Heading 2","h2",{"class":"toolbar_formatmenu_h2"});k.add("Heading 3","h3",{"class":"toolbar_formatmenu_h3"});k.add("Heading 4","h4",{"class":"toolbar_formatmenu_h4"});k.add("Heading 5","h5",{"class":"toolbar_formatmenu_h5"});k.add("Heading 6","h6",{"class":"toolbar_formatmenu_h6"});k.add("Normal","p",{"class":"toolbar_formatmenu_normal"});b.toolbar.add(k);k.originalShow=k.showMenu;k.showMenu=function(){var a=
jQuery(window).scrollTop();k.originalShow();jQuery(window).scrollTop(a);jQuery("#menu_wsMainEditor_wsMainEditor_formatlistbox_menu tr.mceFirst td").css("height",0);jQuery("#menu_wsMainEditor_wsMainEditor_formatlistbox_menu tr.mceFirst td a").html("").css({position:"relative",height:0,padding:0});jQuery("#menu_wsMainEditor_wsMainEditor_formatlistbox_menu_co").css("height","auto").css("width","auto");jQuery("#menu_wsMainEditor_wsMainEditor_formatlistbox_menu").css({borderBottom:"1px solid #d4d0c9",
borderRight:"1px solid #d4d0c9"}).appendTo(document.body);d.plugins.wstoolbarscroll.moveScroller();a=f.DOM.select("a","menu_"+k.menu.id)[1];jQuery(a).is(":visible")&&a.focus();k.menu._focusIdx=1};b.toolbar.add(e.createSeparator());b.toolbar.add(e.createButton("insertorderedlist",{title:"Numbered List",onclick:function(){f.activeEditor.wsExecCommand("wsInsertOrderedList");ws.common.track("Editor","Add Ordered List")}}));b.toolbar.add(e.createButton("insertunorderedlist",{title:"Bulleted List",onclick:function(){f.activeEditor.wsExecCommand("wsInsertUnorderedList");
ws.common.track("Editor","Add Unordered List")}}));b.toolbar.add(e.createButton("hr",{title:"Insert Horizontal Rule",onclick:function(){f.activeEditor.wsExecCommand("wsInsertHorizontalRule");ws.common.track("Editor","Add Horizontal Rule")}}));b.toolbar.add(e.createSeparator());b.toolbar.add(e.createControl("wslink"));b.toolbar.add(e.createControl("wsimage"));b.toolbar.add(e.createControl("wswidget"));b.toolbar.add(e.createControl("wstable"));b.toolbar.add(e.createControl("wscomment"));b.toolbar.add(e.createSeparator());
b.toolbar.add(e.createButton("undo",{title:"Undo",onclick:function(){f.activeEditor.wsExecCommand("Undo");ws.common.track("Editor","Undo")}}));b.toolbar.add(e.createButton("redo",{title:"Redo",onclick:function(){f.activeEditor.wsExecCommand("Redo");ws.common.track("Editor","Redo")}}));b.toolbar.add(e.createSeparator());b.toolbar.add(e.createButton("wspreview",{title:"Preview",label:"Preview","class":"btn",onclick:function(){f.mainEditor.wsExecCommand("preview",!1,!1,{skip_undo:!0});ws.common.track("Editor",
"Preview")}}));b.toolbar.add(e.createButton("wsendpreview",{title:"Continue Editing",label:"Continue Editing","class":"btn continueBtn",onclick:function(){f.mainEditor.wsExecCommand("endPreview",!1,!1,{skip_undo:!0})}}));b.toolbar.add(e.createControl("wscancel"));var l=e.createControl("wssave");b.toolbar.add(l);b.toolbar.renderTo(h);jQuery("#pageEditor").addClass("defaultSkin");jQuery("#wsMainEditor_external").prependTo("#pageEditor");jQuery(h).find(".btn span.mceButtonLabel").wrap("<span />");jQuery(h).find(".btn.mceSplitButton span.mceSplitButtonLabel").wrap("<span />");
jQuery(h).find(".btn.mceSplitButton span.mceOpen").removeClass("btn").wrap("<span />");jQuery.browser.msie&&"8.0"<=jQuery.browser.version&&jQuery(h).find(".btn.mceSplitButton span.mceOpen").html("&zwj;");jQuery(h).find(".btn.mceAction").addClass("pill-l");jQuery(h).find(".btn.mceOpen").addClass("pill-r");jQuery("#wsMainEditor_formatlistbox_open").click(function(){return!1}).bind("mousedown",function(){k.showMenu();return!1});b.preventMenuClose=!1;jQuery("#menu_wsMainEditor_wsMainEditor_wssave_menu").live("mouseover",
function(){b.preventMenuClose=!0;jQuery("#menu_wsMainEditor_wsMainEditor_wssave_menu").die("mouseover");jQuery(this).hover(function(){return b.preventMenuClose=!0},function(){b.preventMenuClose=!1;setTimeout(function(){b.preventMenuClose||l.hideMenu()},500);return!0})});jQuery(h).find("#wsMainEditor_wssave .btn.mceOpen").click(function(a){b.preventMenuClose=!b.preventMenuClose;l.showMenu();a.preventDefault();return!1});jQuery(h).find("#wsMainEditor_wssave .btn.mceOpen").hoverIntent({sensitivity:3,
interval:200,over:function(){l.showMenu()},timeout:500,out:function(){b.preventMenuClose||l.hideMenu()}});jQuery(h).prepend('<table style="width: 100%; border-collapse: collapse; background: transparent;" ><tr style="height: 21px;"><td style="width:10px; background: url(/i/window-bar-nl.png) no-repeat left bottom; padding: 0;"><img src="/i/c.gif" width="10" height="21" alt="" /></td><td style="width:75%; background: url(/i/window-bar-n.png) repeat-x left bottom; padding: 0;"></td><td style="width:23px; background: url(/i/window-bar-yl.png) no-repeat left bottom; padding: 0;"><img src="/i/c.gif" width="23" height="21" alt="" /></td><td style="width:25%; background: url(/i/window-bar-m.png) repeat-x left bottom; padding: 0; text-align: right;"><span id="autosaveStatus"></span></td><td style="width:10px; background: url(/i/window-bar-mr.png) no-repeat left bottom; padding: 0;"><img src="/i/c.gif" width="10" height="21" alt="" /></td></tr></table>');
jQuery("#wsMainEditor_external").css({MozUserSelect:"none",KhtmlUserSelect:"None",cursor:"default"}).bind("selectstart",function(){return!1});a=c.add(g,"div",{"class":"mceIframeContainer editorLayer active_editor",style:"position: relative;"});g=c.add(g,"div",{style:"display: none;"});return{iframeContainer:a,editorContainer:d.id+"_container",sizeContainer:g,deltaHeight:0}},getInfo:function(){return{longname:"Wikispaces theme",author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",version:"0.1"}}});
f.ThemeManager.add("wikispaces",wikispaces.themes.WikispacesTheme)})(tinymce);
(function(f){f.create("wikispaces.plugins.ImageTextPlugin:wikispaces.plugins.ImagePlugin",{init:function(c){var a=this;this.editor=c;c.addCommand("wsimageText",function(){f.mainEditor.plugins.wspopup.show("imageTool",{plugin:a})})},getInfo:function(){return{longname:"Wikispaces image text",author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",infourl:"/web/20130128163946/http://wikispaces.com",version:"0.1"}},insertImageInEditorCallback:function(c,a,b,d,e,f,h){(e=f)&&this.isLocalContext(f)&&(e="");"audio"==b||"video"==
...
(function(f){f.create("wikispaces.plugins.TableTextPlugin:wikispaces.plugins.TablePlugin",{init:function(c){var a=this;this.editor=c;c.addCommand("wsTableText",function(){f.mainEditor.plugins.wspopup.show("tablePopupContents",{plugin:a})})},getInfo:function(){return{longname:"Wikispaces table text",author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",infourl:"/web/20130128163946/http://wikispaces.com",version:"0.1"}},addTable:function(c,a){ws.common.track("Editor","Add Table",c+"x"+a);for(var b="",d=0;d<c;d++){b+=
...
(function(f,c){f.create("wikispaces.plugins.LinkTextPlugin:wikispaces.plugins.LinkPlugin",{init:function(a){var b=this;this.editor=a;a.addCommand("wslinkText",function(){f.mainEditor.plugins.wspopup.show("linkTool",{plugin:b})})},getInfo:function(){return{longname:"Wikispaces link (text)",author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",infourl:"/web/20130128163946/http://wikispaces.com",version:"0.1"}},setupForms:function(){this.editor.wsselection.restore(!0);this.editor.plugins.wstext.expandSelectionToTag("[[",
...
sizeContainer:d,deltaHeight:0}},getInfo:function(){return{longname:"Wikispaces reference theme",author:"Tangient LLC",authorurl:"/web/20130128163946/http://wikispaces.com",version:"0.1"}}});f.ThemeManager.add("reference",wikispaces.themes.ReferenceTheme)})(tinymce);
...
tinymce.plugins.Autoresize)})();window.wikispaces_jsLoaded=window.wikispaces_jsLoaded||[];window.wikispaces_jsLoaded.push({editorc:"2:1f92f6e68593b83b27ff339f848612e9"});
