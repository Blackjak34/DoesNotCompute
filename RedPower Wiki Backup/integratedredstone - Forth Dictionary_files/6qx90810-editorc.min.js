...
/*
     ...
     INTERNET ARCHIVE ON 21:17:29 Mar 8, 2015.
     JAVASCRIPT APPENDED BY WAYBACK MACHINE, COPYRIGHT INTERNET ARCHIVE.

     ALL OTHER CONTENT MAY ALSO BE PROTECTED BY COPYRIGHT (17 U.S.C.
     SECTION 108(a)(3)).
*/
/* 2:190b3f48e2dee60dd6b2c3f10ae361a6 */
...
b){return g(b)}));a.onInit.add(function(){a.controlManager.setActive("pastetext",a.pasteAsPlainText);f(a,"paste_block_drop")&&a.dom.bind(a.getBody(),"dragend,dragover,draggesture,dragdrop,drop,drag".split(","),function(a){a.preventDefault();a.stopPropagation();return false})});h._legacySupport()},getInfo:function(){return{longname:"Paste text/word",author:"Moxiecode Systems AB",authorurl:"/web/20121115124746/http://tinymce.moxiecode.com",infourl:"/web/20121115124746/http://wiki.moxiecode.com/index.php/TinyMCE:Plugins/paste",version:tinymce.majorVersion+
...
"class":"btn",onclick:function(){ws.common.track("Editor","Stop","Cancel");d.timeTracker._recordEndTime();try{_gaq.push(function(){d.timeTracker._track(_gat._getTrackerByName(),void 0,"Editor")})}catch(a){}d.isContentDirty()&&d.editor.plugins.wsautosave.autosave(!1);d.noDirtyCheck=!0;document.location=d.editor.getParam("wssave_cancel_url")}}));return e},getInfo:function(){return{longname:"Wikispaces save",author:"Tangient LLC",authorurl:"/web/20121115124746/http://wikispaces.com",infourl:"/web/20121115124746/http://wikispaces.com",version:"0.1"}},
...
(a.prepend(a.prev().html()),a.prev().remove())},getInfo:function(){return{longname:"Wikispaces list",author:"Tangient LLC",authorurl:"/web/20121115124746/http://wikispaces.com",infourl:"/web/20121115124746/http://wikispaces.com",version:"0.1"}}});f.PluginManager.add("wslist",wikispaces.plugins.ListPlugin)})(tinymce,jQuery);
...
getInfo:function(){return{longname:"Wikispaces toolbar scroll",author:"Tangient LLC",authorurl:"/web/20121115124746/http://wikispaces.com",infourl:"/web/20121115124746/http://wikispaces.com",version:"0.1"}}});f.PluginManager.add("wstoolbarscroll",wikispaces.plugins.ToolbarScrollPlugin)})(tinymce,jQuery);
...
k.initial||("A"==c.nodeName&&!c.name&&-1==c.href.indexOf("#mce_temp_url#")&&"visual"==a.plugins.wscommon.getOption("mode")?f.mainEditor.plugins.wslinkoverlay.show(c):f.mainEditor.plugins.wslinkoverlay.hide())});a.onDblClick.add(function(a,b){"A"==b.target.nodeName&&("A"==b.target.nodeName&&a.selection.select(b.target),a.execCommand("wslink"))});a.plugins.wscommon.disableUntilLibsLoad(a,"wslink")},getInfo:function(){return{longname:"Wikispaces link",author:"Tangient LLC",authorurl:"/web/20121115124746/http://wikispaces.com",
...
height:340,uiSetup:function(a){c("#closePreviewButton").click(function(){a.close()})}});this.registerPlugin({options:{id:"glogster",name:"Glogster",type:"media",category:"poster",logo:"/i/glogster_widget_160x70.jpg",url:"/web/20121115124746/http://edu.glogster.com/?page=wiki_spaces&wikiaction=login",homepage_url:"/web/20121115124746/http://edu.glogster.com",terms_url:"/web/20121115124746/http://edu.glogster.com/terms-of-use"}})},setPlugin:function(a){this.plugin=a},onShow:function(a){this.setPlugin(a.plugin);this.resetMediaForms();a.plugin&&(a.plugin.editor.plugins.wsreference?
...
"digg"==a||"reddit"==a||"anchor"==a||"include"==a.substring(0,7)||c("#"+a+"MediaMenu").is(".hideTextMediaInstructions")?c(document.otherMediaForm).hide():c(document.otherMediaForm).show();"spinner"!=a&&(document.otherMediaForm.mediaType.value=a);c("#"+a+"MediaMenu").find('input[type="text"],textarea').eq(0).focus();this.editor.plugins.wspopup.resize("mediaTool")},submitYackpack:function(){var a="/web/20121115124746/http://www.yackpack.com/walkietalkie/?"+encodeURIComponent(document.yackpackMediaForm.channel.value);document.otherMediaForm.embedText.value=
a;document.otherMediaForm.save.click()},submitBittyBrowser:function(){document.otherMediaForm.embedText.value='bitty browser\nwebsite: "'+document.bittybrowserMediaForm.url.value+'"';document.otherMediaForm.save.click()},embedGabbly:function(){document.otherMediaForm.embedText.value="<iframe src='/web/20121115124746/http://cw.gabbly.com/gabbly/cw.jsp?e=1&t="+encodeURIComponent(location.protocol+"//"+location.host+"/"+wikispaces_page)+"' scrolling='no' style='width:300px; height:250px;' frameborder='0'></iframe>";document.otherMediaForm.save.click()},
...
this,l=a+"-file-"+e,d=this.getCell(a,e);d||(this.addRow(a),d=this.getCell(a,e));a=document.createElement("td");a.style.textAlign="center";a.style.padding="5px;";a.title=b;c(a).dblclick(function(){k.plugin.insertImageInEditor("external",b,"image",g);k.editor.plugins.wspopup.hide("imageTool")});f||(f=document.createElement("img"));g&&(f.src=g,f.height>f.width?(f.width=f.width/f.height*k.IMAGE_SIZE,f.height=k.IMAGE_SIZE):(f.height=f.height/f.width*k.IMAGE_SIZE,f.width=k.IMAGE_SIZE));f.onmousedown=function(){return false};
e=document.createElement("div");e.className="WikiUploadFileEditor";e.appendChild(f);a.appendChild(e);f=c("<span>").attr("id",l).text(ws.common.truncate(b,13));c(e).append("<br/>").append(f);d.parentNode.replaceChild(a,d)},resetPages:function(){var a=this;c("#imagePages").html('<a href="#" class="pageNumber pageCurrent" style="visibility: hidden;">&nbsp;</a>');var b=1,d=this.pageCount;7<this.pageCount&&(b=this.currentPage-1,1>b&&(b=1),d=b+1,d>this.pageCount&&(d=this.pageCount));for(var e=1+d-b+(d==
this.pageCount?0:1)+(1==b?0:1),g=0;7>e&&(1!=b||d!=this.pageCount);)g%2?(b--,1>b&&(b=1)):(d++,d>this.pageCount&&(d=this.pageCount)),g++,e=1+d-b+(d==this.pageCount?0:1)+(1==b?0:1);if(1<this.pageCount){1==this.currentPage?c("#imagePages").append('<span class="pageFirst inactive">&laquo; Previous</span>'):(e=c('<a href="#" class="pageFirst">&laquo; Previous</a>').click(function(){a.showPage(a.currentPage-1)}),c("#imagePages").append(e));1<b&&(this.addPage(1),2<b&&c("#imagePages").append(" ... "));for(g=
b;g<=d;g++)this.addPage(g);this.pageCount>d&&(d+1<this.pageCount&&c("#imagePages").append(" ... "),this.addPage(this.pageCount));this.currentPage==this.pageCount?c("#imagePages").append('<span class="inactive">Next &raquo;</span>'):(b=c('<a href="#">Next &raquo;</a>').click(function(){a.showPage(a.currentPage+1)}),c("#imagePages").append(b))}},loadFileData:function(a){var b=this;c(".fileList ul").empty();var d=0;if("myrecent"==this.currentMode){var e=(b.currentPage-1)*b.PER_PAGE;c.each(this.newUploads,
function(a,g){if(!(a<e)){if(d>=b.PER_PAGE)return!1;var f=b.addFileRow("imageTable",g.f_type,g.f_name,g.r_mime_type,g.f_view_group,g.f_location,g.f_context,null,!0);c(f).attr("id","swfu_file_"+g.id).find("div.fileName").append("&nbsp;&nbsp;").append(c("<a>").attr("href","#").addClass("uploadCancelButton").attr("id",g.id+"cancel").text("cancel").click(function(a){f.remove();b.uploader.removeFile(b.uploader.getFile(g.id));a.preventDefault()})).append('<div class="progressContainer"><div class="progressBar" id="'+
g.id+'progress"></div></div>');d++}})}c.each(a.files,function(a,c){if(d>=b.PER_PAGE)return!1;b.addFileRow("imageTable",c.f_type,c.f_name,c.r_mime_type,c.f_view_group,c.f_location,c.f_context);d++});if(!d){var g=c("<li>").text("No files found").addClass("nodata");c(".fileList ul").append(g);d++}for(;d<this.PER_PAGE;){var g=document.createElement("li"),f=document.createElement("img");f.src="/i/c.gif";f.height=b.IMAGE_SIZE;f.width=b.IMAGE_SIZE;g.appendChild(f);g.appendChild(document.createTextNode(" "));
c(".fileList ul").append(g);d++}this.pageCount=a.pagedata.numpages;this.currentPage=a.pagedata.current;this.resetPages();this.highlightPage(this.currentPage);this.hideFileSpinner()},highlightPage:function(a){c("#imagePages a.pageNumber").each(function(){c(this).html()==a?c(this).addClass("pageCurrent"):c(this).removeClass("pageCurrent")})},externalImageOnloadCallback:function(a){if(0==a.height)alert("The external image could not be found.");else{var b=a.src,c=b.match(/.*\/([^\/\?]+)/);2==c.length&&
...
tagPageChangeCallback:function(){a.resize()}});-1!=navigator.platform.indexOf("Mac")&&c("#ctrlKeyName").html("&#8984;");wikispaces_isUserLoggedIn&&this.setupUploader()},setupUploader:function(){var a=this,b=f.mainEditor;this.uploader=new plupload.Uploader({runtimes:_(ws.common.pluploadRuntimes()).without("silverlight").join(","),browse_button:"uploadFiles",url:b.getParam("wsimage_upload_url"),flash_swf_url:"/s/plupload.flash.swf",silverlight_xap_url:"/s/plupload.silverlight.xap",multipart_params:Cookie.all(),
max_file_size:b.getParam("wsimage_max_file_size_mb")+"MB",drop_element:"imageDivTable",container:"uploadButtons"});this.uploader.init();this.uploader.bind("FilesAdded",function(b,d){_(d).each(function(b){var c="application/octet-stream";a.isImageFilename(b.name)&&(c="image");a.newUploads.push({f_name:b.name,r_mime_type:c,id:b.id})});a.setListMode("myrecent");c("#imageDivTable .filterTagShow").effect("highlight",{},3E3);c("#filenameAutocomplete").val("");c("#imageDiv .WikiTokenAutocomplete .closebutton").click();
c("#uploadFiles").hide();c("#cancelQueueBtn").show();b.refresh();b.start()});this.uploader.bind("UploadProgress",function(a,b){c("#swfu_file_"+b.id).find(".progressBar").css("width",b.percent+"%")});this.uploader.bind("FileUploaded",function(a,b){c("#swfu_file_"+b.id).attr("id","").find(".progressContainer").remove();c("#"+b.id+"cancel").remove()});var d=function(){a.newUploads=[];c("#cancelQueueBtn").hide();c("#uploadFiles").show();$iframe=c("<iframe>").css({width:0,height:0,border:0}).attr("src",
ws.common.pathFor("file","upload")+"?multiModeConfirm=1&remoteMode=true").bind("load",function(){a.setListMode("myrecent");c("#filenameAutocomplete").val("");c("#imageDiv .WikiTokenAutocomplete .closebutton").click()}).appendTo(document.body)};this.uploader.bind("UploadComplete",d);c("#cancelQueueBtn").click(function(){a.uploader.stop();d()});this.uploader.bind("Error",function(a,d){ws.common.logFileUploadError(d,b.getParam("wsimage_max_file_size_mb")+"MB");d.file&&c("#"+d.file.id).length&&c("#"+
d.file.id).removeClass("fileUploading").addClass("uploadError");a.refresh()})},isImage:function(a){switch(a){case "image/png":case "image/x-png":case "image/jpeg":case "image/gif":case "image/jpg":case "image/pjpeg":return!0}return!1},isImageFilename:function(a){return a.match(/.*\.(?:gif|jpg|jpeg|png)$/i)},isMedia:function(a){return this.isAudio(a)||this.isVideo(a)},isAudio:function(a){switch(a){case "audio/mpeg":case "audio/mpg":case "audio/mp3":case "audio/x-mp3":case "audio/x-mpeg":case "audio/x-mpg":case "application/asx":case "application/x-mplayer2":case "audio/x-ms-wma":case "audio/x-ms-wax":case "audio/3gpp":case "audio/3gpp2":case "audio/aac":case "audio/x-aac":case "audio/aiff":case "audio/x-aiff":case "audio/mid":case "audio/midi":case "audio/x-midi":case "audio/mp4":case "audio/m4a":case "audio/x-m4a":case "audio/wav":case "audio/x-wav":case "audio/x-pn-realaudio":case "audio/x-pn-realaudio-plugin":return!0}return!1},
...
author:"Tangient LLC",authorurl:"/web/20121115124746/http://wikispaces.com",infourl:"/web/20121115124746/http://wikispaces.com",version:"0.1"}},getNextRefId:function(){return++this.nextRefId},elementIdToRefId:function(a){return a.match(/-(\d+)$/)[1]},pullOutReferences:function(a){var b=!1,c=this;a.content=a.content.replace(/(&lt;ref(?:&gt;|>)((?:.|\n)*?)&lt;\/ref(?:&gt;|>))|(<pre\s+.*?>)|(<\/pre>)/gmi,function(a,f,h,k,l){if(f&&!b)return a=c.getNextRefId(),f=c.makeReferenceHtml(a),c.addReferenceEditor(a,h),f;k?b=!0:l&&(b=!1);return a})},
...
a.onNodeChange.add(function(a,b,f){ws.editor.content.isLoaded&&b.setDisabled("wsstyle",a.wsselection&&a.wsselection.withinCode());b.setActive("wsstyle",0<c(f).closest("span,div,font,strike,s").length)});a.plugins.wscommon.disableUntilLibsLoad(a,"wsstyle")},getInfo:function(){return{longname:"Wikispaces style",author:"Tangient LLC",authorurl:"/web/20121115124746/http://wikispaces.com",infourl:"/web/20121115124746/http://wikispaces.com",version:"0.1"}},applyStyle:function(){ws.common.track("Editor","Apply Style");var a=c(document.styleForm.styleText).val(),
...
a.plugins.wscommon.cursorToAndRemoveElement(c("#wsHold",a.getDoc()).get(0));h&&"\n"==g.text().substr(-1)&&(a.selection.setContent('\n<span id="wsHold"></span>'),a.plugins.wscommon.cursorToAndRemoveElement(c("#wsHold",a.getDoc()).get(0)));b.preventDefault();b.stopPropagation();return!1}}});a.plugins.wscommon.disableUntilLibsLoad(a,"wswidget")},getInfo:function(){return{longname:"Wikispaces widgets",author:"Tangient LLC",authorurl:"/web/20121115124746/http://wikispaces.com",infourl:"/web/20121115124746/http://wikispaces.com",version:"0.1"}},
...
a.onModeSwitch.add(function(a){"visual"==a?_.defer(function(){WikispacesCommentManager.showAll()}):"plain"==a&&WikispacesCommentManager.hideAll()})},getInfo:function(){return{longname:"Wikispaces comment",author:"Tangient LLC",authorurl:"/web/20121115124746/http://wikispaces.com",infourl:"/web/20121115124746/http://wikispaces.com",version:"0.1"}},isAutoSaveComments:function(a){return _(a).any(function(a){return _.isString(a)})},loadComments:function(a){this.isAutoSaveComments(a)?WikispacesCommentManager.retrieveData(function(){_(a).each(function(a,
...
jQuery("#wsMainEditor_external").css({MozUserSelect:"none",KhtmlUserSelect:"None",cursor:"default"}).bind("selectstart",function(){return!1});a=c.add(g,"div",{"class":"mceIframeContainer editorLayer active_editor",style:"position: relative;"});g=c.add(g,"div",{style:"display: none;"});return{iframeContainer:a,editorContainer:d.id+"_container",sizeContainer:g,deltaHeight:0}},getInfo:function(){return{longname:"Wikispaces theme",author:"Tangient LLC",authorurl:"/web/20121115124746/http://wikispaces.com",version:"0.1"}}});
f.ThemeManager.add("wikispaces",wikispaces.themes.WikispacesTheme)})(tinymce);
(function(f){f.create("wikispaces.plugins.ImageTextPlugin:wikispaces.plugins.ImagePlugin",{init:function(c){var a=this;this.editor=c;c.addCommand("wsimageText",function(){f.mainEditor.plugins.wspopup.show("imageTool",{plugin:a})})},getInfo:function(){return{longname:"Wikispaces image text",author:"Tangient LLC",authorurl:"/web/20121115124746/http://wikispaces.com",infourl:"/web/20121115124746/http://wikispaces.com",version:"0.1"}},insertImageInEditorCallback:function(c,a,b,d,e,f,h){(e=f)&&this.isLocalContext(f)&&(e="");"audio"==b||"video"==
...
(function(f){f.create("wikispaces.plugins.TableTextPlugin:wikispaces.plugins.TablePlugin",{init:function(c){var a=this;this.editor=c;c.addCommand("wsTableText",function(){f.mainEditor.plugins.wspopup.show("tablePopupContents",{plugin:a})})},getInfo:function(){return{longname:"Wikispaces table text",author:"Tangient LLC",authorurl:"/web/20121115124746/http://wikispaces.com",infourl:"/web/20121115124746/http://wikispaces.com",version:"0.1"}},addTable:function(c,a){ws.common.track("Editor","Add Table",c+"x"+a);for(var b="",d=0;d<c;d++){b+=
...
(function(f,c){f.create("wikispaces.plugins.LinkTextPlugin:wikispaces.plugins.LinkPlugin",{init:function(a){var b=this;this.editor=a;a.addCommand("wslinkText",function(){f.mainEditor.plugins.wspopup.show("linkTool",{plugin:b})})},getInfo:function(){return{longname:"Wikispaces link (text)",author:"Tangient LLC",authorurl:"/web/20121115124746/http://wikispaces.com",infourl:"/web/20121115124746/http://wikispaces.com",version:"0.1"}},setupForms:function(){this.editor.wsselection.restore(!0);this.editor.plugins.wstext.expandSelectionToTag("[[",
...
sizeContainer:d,deltaHeight:0}},getInfo:function(){return{longname:"Wikispaces reference theme",author:"Tangient LLC",authorurl:"/web/20121115124746/http://wikispaces.com",version:"0.1"}}});f.ThemeManager.add("reference",wikispaces.themes.ReferenceTheme)})(tinymce);
...
tinymce.plugins.Autoresize)})();window.wikispaces_jsLoaded=window.wikispaces_jsLoaded||[];window.wikispaces_jsLoaded.push({editorc:"2:190b3f48e2dee60dd6b2c3f10ae361a6"});
