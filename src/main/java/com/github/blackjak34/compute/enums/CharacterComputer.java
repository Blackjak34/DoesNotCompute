...
public enum CharacterComputer {
	SPACE				(32, 2, 0, 56),
	EXCLAMATION			(33, 2, 1, 36),
	DOUBLE_QUOTE		(34, 2, 2, 50),
	HASH				(35, 2, 3, 38),
	DOLLAR				(36, 2, 4, 39),
	PERCENT				(37, 2, 5, 40),
	AMPERSAND			(38, 2, 6, 56),
	SINGLE_QUOTE		(39, 2, 7, 56),
	OPEN_PARENTHESIS	(40, 2, 8, 42),
	CLOSE_PARENTHESIS	(41, 2, 9, 43),
	ASTERISK			(42, 2, 10, 41),
	SUM					(43, 2, 11, 46),
	COMMA				(44, 2, 12, 54),
	DIFFERENCE			(45, 2, 13, 44),
	DECIMAL				(46, 2, 14, 55),
	FORWARD_SLASH		(47, 2, 15, 52),
	ZERO				(48, 3, 0, 0),
	ONE					(49, 3, 1, 1),
	TWO					(50, 3, 2, 2),
	THREE				(51, 3, 3, 3),
	...
	NINE				(57, 3, 9, 9),
	COLON				(58, 3, 10, 48),
	SEMICOLON			(59, 3, 11, 49),
	LESS_THAN			(60, 3, 12, 56),
	EQUALS				(61, 3, 13, 47),
	GREATER_THAN		(62, 3, 14, 56),
	QUESTION			(63, 3, 15, 53),
	AT					(64, 0, 0, 37),
	CAPITAL_A			(65, 4, 1, 10),
	CAPITAL_B			(66, 4, 2, 11),
	...
	OPEN_BRACKET		(91, 1, 11, 56),
	BACKWARD_SLASH		(92, 2, 15, 56),
	CLOSE_BRACKET		(93, 1, 13, 56),
	CAROT				(94, 2, 0, 56),
	UNDERSCORE			(95, 6, 4, 45),
	BACKTICK			(96, 2, 7, 56),
	LOWER_A				(97, 0, 1, 10),
	LOWER_B				(98, 0, 2, 11),
	LOWER_C				(99, 0, 3, 12),
	...
	LOWER_Y				(121, 1, 9, 34),
	LOWER_Z				(122, 1, 10, 35),
	OPEN_BRACE			(123, 1, 11, 56),
	VERTICAL_BAR		(124, 5, 13, 51),
	CLOSE_BRACE			(125, 1, 13, 56),
	TILDE				(126, 2, 0, 56),
	DELETE				(127, 1, 15, 56),
    SPACE_I				(160, 10, 0, 56),
    EXCLAMATION_I		(161, 10, 1, 36),
    DOUBLE_QUOTE_I		(162, 10, 2, 50),
    HASH_I				(163, 10, 3, 38),
    DOLLAR_I			(164, 10, 4, 39),
    PERCENT_I			(165, 10, 5, 40),
    AMPERSAND_I			(166, 10, 6, 56),
    SINGLE_QUOTE_I		(167, 10, 7, 56),
    OPEN_PARENTHESIS_I	(168, 10, 8, 42),
    CLOSE_PARENTHESIS_I	(169, 10, 9, 43),
    ASTERISK_I			(170, 10, 10, 41),
    SUM_I				(171, 10, 11, 46),
    COMMA_I				(172, 10, 12, 54),
    DIFFERENCE_I		(173, 10, 13, 44),
    DECIMAL_I			(174, 10, 14, 55),
    FORWARD_SLASH_I		(175, 10, 15, 52),
    ZERO_I				(176, 11, 0, 0),
    ONE_I				(177, 11, 1, 1),
    TWO_I				(178, 11, 2, 2),
    THREE_I				(179, 11, 3, 3),
    ...
    EIGHT_I				(184, 11, 8, 8),
    NINE_I				(185, 11, 9, 9),
    COLON_I				(186, 11, 10, 48),
    SEMICOLON_I			(187, 11, 11, 49),
    LESS_THAN_I			(188, 11, 12, 56),
    EQUALS_I			(189, 11, 13, 47),
    GREATER_THAN_I		(190, 11, 14, 56),
    QUESTION_I			(191, 11, 15, 53),
    AT_I				(192, 8, 0, 37),
    ...
    OPEN_BRACKET_I		(219, 9, 11, 56),
    BACKWARD_SLASH_I	(220, 10, 15, 56),
    CLOSE_BRACKET_I		(221, 9, 13, 56),
    CAROT_I				(222, 10, 0, 56),
    UNDERSCORE_I		(223, 14, 4, 45),
    BACKTICK_I			(224, 10, 7, 56),
    ...
    OPEN_BRACE_I		(251, 9, 11, 56),
    VERTICAL_BAR_I		(252, 13, 13, 51),
    CLOSE_BRACE_I		(253, 9, 13, 56),
    TILDE_I				(254, 10, 0, 56),
    DELETE_I			(255, 9, 15, 56),
	INVALID				(-1, 2, 0, 56);
