...
public enum InstructionComputer {
	...
	NXT			(0x02, 0, 3, false, false),
	ORA_STK		(0x03, 2, 4, false, false),
	TSB_ZP		(0x04, 2, 5, false, false),
	ORA_ZP		(0x05, 2, 3, false, false),
	ASL_ZP		(0x06, 2, 5, false, false),
	ORA_RSTK	(0x07, 2, 4, false, false),
	...
	ENT			(0x22, 1, 5, false, false),
	AND_STK		(0x23, 2, 4, false, false),
	BIT_ZP		(0x24, 2, 3, false, false),
	AND_ZP		(0x25, 2, 3, false, false),
	ROL_ZP		(0x26, 2, 5, false, false),
	AND_RSTK	(0x27, 2, 4, false, false),
	...
	NXA			(0x42, 1, 3, false, false),
	EOR_STK		(0x43, 2, 4, false, false),
	REA_ABS		(0x44, 3, 5, false, false),
	EOR_ZP		(0x45, 2, 3, false, false),
	LSR_ZP		(0x46, 2, 5, false, false),
	EOR_RSTK	(0x47, 2, 4, false, false),
	...
	// This instruction is indirect
	EOR_STK_Y	(0x53, 2, 7, false, false),
	REI_IND		(0x54, 3, 6, false, false),
	EOR_ZP_X	(0x55, 2, 4, false, false),
	LSR_ZP_X	(0x56, 2, 6, false, false),
	// This instruction is indirect
	EOR_RSTK_Y	(0x57, 2, 7, false, false),
	...
	PER_REL		(0x62, 3, 6, false, false),
	ADC_STK		(0x63, 2, 4, false, false),
	STZ_ZP		(0x64, 2, 3, false, false),
	ADC_ZP		(0x65, 2, 3, false, false),
	ROR_ZP		(0x66, 2, 5, false, false),
	ADC_RSTK	(0x67, 2, 4, false, false),
	...
	RER_REL		(0x82, 3, 6, false, false),
	STA_STK		(0x83, 2, 4, false, false),
	STY_ZP		(0x84, 2, 3, false, false),
	STA_ZP		(0x85, 2, 3, false, false),
	STX_ZP		(0x86, 2, 3, false, false),
	STA_RSTK	(0x87, 2, 4, false, false),
	...
	REP_IMM		(0xC2, 2, 3, false, false),
	CMP_STK		(0xC3, 2, 4, false, false),
	CPY_ZP		(0xC4, 2, 3, false, false),
	CMP_ZP		(0xC5, 2, 3, false, false),
	DEC_ZP		(0xC6, 2, 5, false, false),
	CMP_RSTK	(0xC7, 2, 4, false, false),
	...
	// This instruction is indirect
	CMP_STK_Y	(0xD3, 2, 7, false, false),
	PEI_IND		(0xD4, 2, 6, false, false),
	CMP_ZP_X	(0xD5, 2, 4, false, false),
	DEC_ZP_X	(0xD6, 2, 6, false, false),
	// This instruction is indirect
	CMP_RSTK_Y	(0xD7, 2, 7, false, false),
	...
	// This instruction is indirect
	SBC_STK_Y	(0xF3, 2, 7, false, false),
	PEA_ABS		(0xF4, 3, 5, false, false),
	SBC_ZP_X	(0xF5, 2, 4, false, false),
	INC_ZP_X	(0xF6, 2, 6, false, false),
	// This instruction is indirect
	SBC_RSTK_Y	(0xF7, 2, 7, false, false),
